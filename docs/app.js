...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function xf(){return new Ve({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rl(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function yf(){return new Ve({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rl(),fragmentShader:`
...
`)}var ly={[Qc]:"Linear",[th]:"Reinhard",[eh]:"Cineon",[nh]:"ACESFilmic",[sh]:"AgX",[rh]:"Neutral",[ih]:"Custom"};function cy(n,t){let e=ly[t];return e===void 0?(Rt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Tl=new R;function hy(){Gt.getLuminanceCoefficients(Tl);let n=Tl.x.toFixed(4),t=Tl.y.toFixed(4),e=Tl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}var yy={[Yr]:"SHADOWMAP_TYPE_PCF",[Ws]:"SHADOWMAP_TYPE_VSM"};function vy(n){return yy[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var by={[Ri]:"ENVMAP_TYPE_CUBE",[is]:"ENVMAP_TYPE_CUBE",[$r]:"ENVMAP_TYPE_CUBE_UV"};function My(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":by[n.envMapMode]||"ENVMAP_TYPE_CUBE"}var Sy={[is]:"ENVMAP_MODE_REFRACTION"};function wy(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":Sy[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Ty={[jc]:"ENVMAP_BLENDING_MULTIPLY",[Jd]:"ENVMAP_BLENDING_MIX",[Kd]:"ENVMAP_BLENDING_ADD"};function Ey(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":Ty[n.combine]||"ENVMAP_BLENDING_NONE"}function Ay(n){let t=n.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function Cy(n,t,e,i){let s=n.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=vy(e),l=My(e),u=wy(e),d=Ey(e),h=Ay(e),f=uy(e),g=dy(r),y=s.createProgram(),m,p,A=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(sa).join(`
`)),a=Nh(a),a=Rf(a,e),a=Pf(a,e),o=Nh(o),o=Rf(o,e),o=Pf(o,e),a=If(a),o=If(o),e.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
`)+`
`+p);let S=A+m+a,M=A+p+o,C=Ef(s,s.VERTEX_SHADER,S),T=Ef(s,s.FRAGMENT_SHADER,M);s.attachShader(y,C),s.attachShader(y,T),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function P(I){if(n.debug.checkShaderErrors){let B=s.getProgramInfoLog(y)||"",$=s.getShaderInfoLog(C)||"",J=s.getShaderInfoLog(T)||"",z=B.trim(),q=$.trim(),W=J.trim(),Q=!0,nt=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(Q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,y,C,T);else{let et=Cf(s,C,"vertex"),ot=Cf(s,T,"fragment");Nt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
void main() {
  ...
  if (!visible(xyz)) discard;
  gl_FragColor = vec4(shown(xyz), uOpacity);
}`,bv="varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }",gp="varying vec3 vPos; void main(){ vPos = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }",ru=()=>({uSpace:{value:0},uCvd:{value:0},uHueAll:{value:1},uSev:{value:1},uOpacity:{value:1},uScale:{value:1},uMid:{value:new R},uLo:{value:new R},uHi:{value:new R},uWhite:{value:new R},uIptW:{value:new R},uLB:{value:new xt},uCB:{value:new xt},uHue:{value:new xt},uLmsLab:{value:new wt},uXyzLms:{value:new wt},uLmsXyz:{value:new wt},uLabLms:{value:new wt},uIptOppI:{value:new wt},uIptLmsI:{value:new wt},uGamut:{value:new wt},uLinSrgb:{value:new wt},uVis:{value:ke.VISIBLE.map(n=>new R(...n))},uXyzSrgb:{value:new wt},uCvdM:{value:new wt},uBr1:{value:nn([ke.BRETTEL_TRITAN.h1.slice(0,3),ke.BRETTEL_TRITAN.h1.slice(3,6),ke.BRETTEL_TRITAN.h1.slice(6)])},uBr2:{value:nn([ke.BRETTEL_TRITAN.h2.slice(0,3),ke.BRETTEL_TRITAN.h2.slice(3,6),ke.BRETTEL_TRITAN.h2.slice(6)])},uBrN:{value:new R(...ke.BRETTEL_TRITAN.n)},uBrMix:{value:0},uIcOppI:{value:new wt},uIcLmsI:{value:new wt},uCamBack:{value:new wt},uPq:{value:new ce},uPq2:{value:new xt},uIcK:{value:1},uCam:{value:new ce},uCam2:{value:new xt}});function au(n){let t=ke;n.uSpace.value=pp[Jt.space],n.uLo.value.fromArray(Mt.lo),n.uHi.value.fromArray(Mt.hi),n.uMid.value.fromArray(Mt.mid),n.uScale.value=Mt.s,n.uWhite.value.fromArray(t.CHART_WHITE),n.uIptW.value.fromArray(t.IPT.W),n.uLmsLab.value.copy(nn(t.LMS_LAB)),n.uXyzLms.value.copy(nn(t.XYZ_LMS)),n.uLmsXyz.value.copy(nn(t.LMS_XYZ)),n.uLabLms.value.copy(nn(t.LAB_LMS)),n.uIptOppI.value.copy(nn(t.IPT.OPP_I)),n.uIptLmsI.value.copy(nn(t.IPT.LMS_I)),n.uGamut.value.copy(nn(t.rgbFromXYZ(Jt.gamut))),n.uLinSrgb.value.copy(nn(t.rgbFromXYZ("srgb"))),n.uXyzSrgb.value.copy(nn(t.xyzFromRGB("srgb")));let e=t.ICTCP,i=t.CAM;n.uIcOppI.value.copy(nn(e.OPP_I)),n.uIcLmsI.value.copy(nn(e.LMS_I)),n.uIcK.value=e.K,n.uPq.value.set(e.PQ.m1,e.PQ.m2,e.PQ.c1,0),n.uPq2.value.set(e.PQ.c2,e.PQ.c3),n.uCamBack.value.copy(nn(i.BACK)),n.uCam.value.set(i.Aw,i.Nbb,i.c*i.z,i.n),n.uCam2.value.set(i.FL,i.Nc*i.Ncb),n.uLB.value.set(v.lo[0],v.hi[0]),n.uCB.value.set(v.lo[1],v.hi[1]),n.uHue.value.fromArray(v.hue),n.uHueAll.value=v.hue[0]===0&&v.hue[1]===360?1:0,n.uCvd.value=mp[v.cvd],n.uSev.value=v.sev,v.cvd!=="none"&&(n.uCvdM.value.set(...t.cvdMatrix(v.cvd,v.sev)),n.uBrMix.value=v.cvd==="tritan"?ac(v.sev):0)}var Ge=24;function Mv(n,t,e){let i=[],s=r=>t[0]*r[0]+t[1]*r[1]+t[2]*r[2]-e;for(let r=0;r<n.length;r++){let a=n[r],o=n[(r+1)%n.length],c=s(a),l=s(o);if(c>=-1e-12&&i.push(a),c>1e-12&&l<-1e-12||c<-1e-12&&l>1e-12){let u=c/(c-l);i.push([0,1,2].map(d=>a[d]+u*(o[d]-a[d])))}}return i}function Sv(){let n=[];for(let e=0;e<3;e++)n.push({n:[0,1,2].map(i=>i===e?1:0),d:0}),n.push({n:[0,1,2].map(i=>i===e?-1:0),d:-1});let t=ke.xyzFromRGB(Jt.gamut);for(let e of ke.VISIBLE){let i=[0,1,2].map(r=>t[0][r]*e[0]+t[1][r]*e[1]+t[2][r]*e[2]),s=Math.hypot(...i);s>1e-12&&n.push({n:i.map(r=>r/s),d:0})}return n}function ha(){let n=Sv(),t=[],e=[],i=0;for(let s=0;s<n.length;s++){let{n:r,d:a}=n[s],o=Math.abs(r[0])<.9?[1,0,0]:[0,1,0],c=[r[1]*o[2]-r[2]*o[1],r[2]*o[0]-r[0]*o[2],r[0]*o[1]-r[1]*o[0]],l=Math.hypot(...c);if(l<1e-12)continue;let u=c.map(S=>S/l),d=[r[1]*u[2]-r[2]*u[1],r[2]*u[0]-r[0]*u[2],r[0]*u[1]-r[1]*u[0]],h=4,f=r.map(S=>S*a),g=[[-1,-1],[1,-1],[1,1],[-1,1]].map(([S,M])=>[0,1,2].map(C=>f[C]+h*(S*u[C]+M*d[C])));for(let S=0;S<n.length&&g.length;S++)S!==s&&(g=Mv(g,n[S].n,n[S].d));if(g.length<3)continue;let y=g.map(S=>hr(S)),m=0;for(let S=1;S<g.length;S++)y[S][0]<y[m][0]&&(m=S);let p=y[m][0]<5?3:1,A=r.map(S=>-S);for(let S=1;S+1<g.length;S++){let M=(m+S)%g.length,C=(m+S+1)%g.length,T=g[M],P=g[C],x=y[M][0]<5,E=y[C][0]<5,D=et=>x&&!E?et**3:E&&!x?1-(1-et)**3:et,I=t.length/3;for(let et=0;et<=Ge;et++){let ot=(et/Ge)**p;for(let at=0;at<=Ge;at++){let Yt=D(at/Ge),fe=[0,1,2].map(rt=>g[m][rt]+ot*((1-Yt)*(T[rt]-g[m][rt])+Yt*(P[rt]-g[m][rt]))),qt=hr(fe);i=Math.max(i,Math.hypot(qt[1],qt[2]));let Z=Yn(qt);t.push(Z.x,Z.y,Z.z)}}let B=[0,1,2].map(et=>(g[m][et]+T[et]+P[et])/3),$=Yn(hr(B)),J=Yn(hr(B.map((et,ot)=>et+.001*A[ot]))).sub($),z=I+(Ge-1)*(Ge+1)+(Ge>>1),[q,W,Q]=[z,z+1,z+Ge+1].map(et=>new R(t[3*et],t[3*et+1],t[3*et+2])),nt=W.sub(q).cross(Q.sub(q)).dot(J)<0;for(let et=0;et<Ge;et++)for(let ot=0;ot<Ge;ot++){let at=I+et*(Ge+1)+ot;e.push(...nt?[at,at+Ge+1,at+1,at+1,at+Ge+1,at+Ge+2]:[at,at+1,at+Ge+1,at+1,at+Ge+2,at+Ge+1])}}}Ol.setAttribute("position",new ee(new Float32Array(t),3)),Ol.setIndex(e),Ol.computeBoundingSphere(),Kp=i,jp(),ki=null}var Ol=new he,Pn=new ae(Ol,new Ve({vertexShader:gp,fragmentShader:yv,transparent:!0,side:Me,depthWrite:!1,uniforms:ru()}));Pn.renderOrder=2;Pn.layers.set(1);Vi.add(Pn);function wv(){au(Pn.material.uniforms),Pn.material.uniforms.uOpacity.value=v.shell,Ev(),ou()}var ar=new yn;ar.layers.set(1);Vi.add(ar);var mn=36,Dl=()=>cr[1]*1.35,ki=null,Yf=(n,t,e,i)=>{if(n===0)return[t,(2*e-1)*Dl(),(2*i-1)*Dl()];if(n===1){let r=e*2*Math.PI;return[i*100,t*Math.cos(r),t*Math.sin(r)]}let s=t*Math.PI/180;return[i*100,e*Dl()*Math.cos(s),e*Dl()*Math.sin(s)]},Tv=(n,t,e)=>{let i=Math.atan2(t[2],t[1]);return n===0?[e,0,0]:n===1?[0,e*Math.cos(i),e*Math.sin(i)]:[0,-e*Math.sin(i),e*Math.cos(i)]};function Ev(){let n=`${v.lo}|${v.hi}|${v.hue}|${Jt.space}|${Jt.gamut}`;if(n===ki)return;ki=n,ar.clear();let t=[...v.lo[0]>0?[[0,v.lo[0],-1]]:[],...v.hi[0]<100?[[0,v.hi[0],1]]:[],...v.lo[1]>0?[[1,v.lo[1],-1]]:[],...v.hi[1]<cr[1]-1e-9?[[1,v.hi[1],1]]:[],...v.hue[0]===0&&v.hue[1]===360?[]:[[2,v.hue[0],-1],[2,v.hue[1],1]]];for(let[e,i,s]of t){let r=[],a=[];for(let m=0;m<=mn;m++)for(let p=0;p<=mn;p++)r.push(...Yn(Yf(e,i,p/mn,m/mn)).toArray());for(let m=0;m<mn;m++)for(let p=0;p<mn;p++){let A=m*(mn+1)+p;a.push(A,A+1,A+mn+1,A+1,A+mn+2,A+mn+1)}let o=Yf(e,i,.5,.5),c=Tv(e,o,s),l=Yn(o.map((m,p)=>m+.001*c[p])).sub(Yn(o)),u=6*((mn/2|0)*mn+(mn/2|0)),[d,h,f]=[0,1,2].map(m=>new R().fromArray(r,3*a[u+m]));if(h.sub(d).cross(f.sub(d)).dot(l)<0)for(let m=0;m<a.length;m+=3)[a[m+1],a[m+2]]=[a[m+2],a[m+1]];let g=new he;g.setAttribute("position",new ee(r,3)),g.setIndex(a);let y=new ae(g,new Ve({vertexShader:gp,fragmentShader:vv,transparent:!0,side:Me,depthWrite:!1,uniforms:{...ru(),uCap:{value:e}}}));y.layers.set(1),y.renderOrder=2,ar.add(y)}ou()}function ou(){for(let n of ar.children)au(n.material.uniforms),n.material.uniforms.uOpacity.value=v.shell}var Ks=(n,t)=>Mt.lo[n]+(Mt.hi[n]-Mt.lo[n])*t,_p=[{corners:n=>[[n,Mt.lo[1],Mt.lo[2]],[n,Mt.hi[1],Mt.lo[2]],[n,Mt.hi[1],Mt.hi[2]],[n,Mt.lo[1],Mt.hi[2]]],at:(n,t,e)=>[n,Ks(1,t),Ks(2,e)],normal:()=>new R(0,1,0)},{corners:n=>[[Mt.lo[0],n,Mt.lo[2]],[Mt.lo[0],n,Mt.hi[2]],[Mt.hi[0],n,Mt.hi[2]],[Mt.hi[0],n,Mt.lo[2]]],at:(n,t,e)=>[Ks(0,e),n,Ks(2,t)],normal:()=>new R(1,0,0)},{corners:n=>[[Mt.lo[0],Mt.lo[1],n],[Mt.lo[0],Mt.hi[1],n],[Mt.hi[0],Mt.hi[1],n],[Mt.hi[0],Mt.lo[1],n]],at:(n,t,e)=>[Ks(0,e),Ks(1,t),n],normal:()=>new R(0,0,1)}];function Av(){return new Ve({vertexShader:bv,fragmentShader:xv,transparent:!0,depthWrite:!0,side:fn,uniforms:{...ru(),uAxis:{value:0},uT:{value:0}}})}var lu=_p.map((n,t)=>{let e=new he;e.setAttribute("position",new ee(new Float32Array(12),3)),e.setAttribute("uv",new ee([0,0,1,0,1,1,0,1],2)),e.setIndex([0,1,2,0,2,3]);let i=new ae(e,Av()),s=new zs(new he().setAttribute("position",e.attributes.position),new ni({color:3355450}));return s.renderOrder=1,i.layers.set(3),s.layers.set(3),Vi.add(i,s),{ax:n,k:t,geo:e,mesh:i,edge:s}});function xp(n){let t=v.slice[n.k],e=n.geo.attributes.position;n.ax.corners(t).forEach((s,r)=>e.setXYZ(r,...ds(s).toArray())),e.needsUpdate=!0,n.geo.computeBoundingSphere();let i=n.mesh.material.uniforms;au(i),i.uAxis.value=n.k,i.uT.value=t,i.uOpacity.value=v.sliceOp}var cu=[];for(let n=0;n<8;n++)for(let t of[1,2,4])n&t||cu.push([n,n|t]);var hu=new he;hu.setAttribute("position",new ee(new Float32Array(cu.length*6),3));var $l=new Fr(hu,new ni({color:3816002,transparent:!0,opacity:.5,depthWrite:!1}));$l.layers.set(1);$l.renderOrder=0;Vi.add($l);var Cv=new R;function Rv(){if(!Mt)return;let{lo:n,hi:t}=Mt,e=Array.from({length:8},(a,o)=>ds([o&1?t[0]:n[0],o&2?t[1]:n[1],o&4?t[2]:n[2]])),i=0,s=1/0;for(let a=0;a<8;a++){let o=Cv.copy(e[a]).project(hs).z;o<s&&(s=o,i=a)}let r=hu.attributes.position;cu.forEach(([a,o],c)=>{let l=a===i||o===i?e[a]:e[o];r.setXYZ(2*c,e[a].x,e[a].y,e[a].z),r.setXYZ(2*c+1,l.x,l.y,l.z)}),r.needsUpdate=!0}var Oi=n=>new Vn({transparent:!0,depthTest:!1,...n}),os=new ae(new he,Oi({vertexColors:!0})),Qs=new ae(new he,Oi({color:0,side:Me}));Qs.renderOrder=6;os.renderOrder=7;Vi.add(os,Qs);function Pv(){os.geometry.dispose(),Qs.geometry.dispose();let n=v.mode==="continuous"?Sa().filter(e=>e.length>=2):[];if(os.visible=Qs.visible=n.length>0,!os.visible){os.geometry=Qs.geometry=new he;return}let t=n.map(e=>Iv(e));os.geometry=$f(t.map(e=>e.body)),Qs.geometry=$f(t.map(e=>e.edge))}function $f(n){if(n.length===1)return n[0];let t=Object.keys(n[0].attributes),e=new he;for(let r of t){let a=n[0].attributes[r].itemSize,o=new Float32Array(n.reduce((l,u)=>l+u.attributes[r].count*a,0)),c=0;for(let l of n)o.set(l.attributes[r].array,c),c+=l.attributes[r].count*a;e.setAttribute(r,new Ke(o,a))}let i=[],s=0;for(let r of n){for(let a of r.index.array)i.push(a+s);s+=r.attributes.position.count,r.dispose()}return e.setIndex(i),e}function Iv(n){let t=Math.min(200,n.length),e=8,i=new Gs(n.map(Yn)),s=new Gr(i,t,1.3,e,!1),r=s.clone();{let o=s.attributes.position,c=r.attributes.position,l=1.75/1.3;for(let u=0;u<=t;u++){let d=u*(e+1),h=0,f=0,g=0;for(let y=0;y<e;y++)h+=o.getX(d+y),f+=o.getY(d+y),g+=o.getZ(d+y);h/=e,f/=e,g/=e;for(let y=0;y<=e;y++)c.setXYZ(d+y,h+(o.getX(d+y)-h)*l,f+(o.getY(d+y)-f)*l,g+(o.getZ(d+y)-g)*l)}c.needsUpdate=!0}let a=new Float32Array(s.attributes.position.count*3);for(let o=0;o<=t;o++){let c=Yl(n[Math.min(n.length-1,Math.round(o/t*(n.length-1)))]);for(let l=0;l<=e;l++)a.set(c,(o*(e+1)+l)*3)}return s.setAttribute("color",new ee(a,3)),r.setAttribute("color",new ee(a.slice(),3)),{body:s,edge:r}}var Gl=new yn,Hl=new yn,ls=new yn;Vi.add(Gl,Hl,ls);var Wl=new Si(2.6,20,14),Lv=new Si(3.4,20,14),Dv=new Si(4.6,20,14),Nv=new R(.62,.5,.6).normalize();function Uv(){Gl.clear(),v.pts.forEach((n,t)=>{let e=v.sel?.kind==="pt"&&v.sel.i===t,i=v.marks.includes(t),s=new ae(Lv,Oi({color:i?8246268:e?16777215:855312,side:Me})),r=new ae(Wl,Oi({}));if(r.material.color.setRGB(...Yl(n)),s.renderOrder=8,r.renderOrder=9,s.add(r),v.pin[t]){let a=new ae(Dv,Oi({color:16761165,side:Me}));a.renderOrder=7,s.add(a)}s.position.copy(Yn(n)),s.userData={kind:"pt",i:t},Gl.add(s)})}function Fv(){Hl.clear(),v.obs.forEach((n,t)=>{let e=(v.sel?.kind==="obs"||v.sel?.kind==="obsr")&&v.sel.i===t,i=new Si(ya(n.r)*Mt.s,28,18),s=new ae(i,new Vn({color:16735067,transparent:!0,opacity:e?.26:.13,depthWrite:!1}));s.add(new ae(i,new Vn({color:e?16777215:16735067,wireframe:!0,transparent:!0,opacity:.3}))),s.position.copy(Yn(n.c)),s.userData={kind:"obs",i:t};let r=new ae(Wl,Oi({color:e?16766826:13193039}));r.scale.setScalar(.7),r.position.copy(s.position).addScaledVector(Nv,ya(n.r)*Mt.s),r.renderOrder=8,r.userData={kind:"obsr",i:t},Hl.add(s,r)})}var Ov=n=>new R(n[1],n[0],n[2]).normalize(),Bv=n=>[n.y,n.x,n.z],yp=n=>Mt.mid.map((t,e)=>t+(n.d-gr(n.n,Mt.mid))*n.n[e]),Zf=26,kv=15;function zv(){ls.clear(),v.planes.forEach((n,t)=>{let e=v.sel?.kind==="plane"&&v.sel.i===t,i=ds(yp(n)),s=Ov(n.n),r=new R(0,1,0).cross(s);r.lengthSq()<1e-6&&r.set(1,0,0),r.normalize();let a=new R().crossVectors(s,r),o=[[-1,-1],[1,-1],[1,1],[-1,1]].map(([h,f])=>i.clone().addScaledVector(r,h*Zf).addScaledVector(a,f*Zf)),c=new he().setFromPoints(o);c.setIndex([0,1,2,0,2,3]),ls.add(new ae(c,new Vn({color:16735067,transparent:!0,opacity:e?.22:.1,side:fn,depthWrite:!1}))),ls.add(new zs(new he().setAttribute("position",c.attributes.position),new ni({color:16735067,transparent:!0,opacity:e?1:.6})));let l=i.clone().addScaledVector(s,kv);ls.add(new es(new he().setFromPoints([i,l]),new ni({color:16735067})));let u=new ae(Wl,Oi({color:e?16777215:16735067}));u.position.copy(i),u.renderOrder=8,u.userData={kind:"plane",i:t};let d=new ae(Wl,Oi({color:e?16766826:13193039}));d.scale.setScalar(.75),d.position.copy(l),d.renderOrder=8,d.userData={kind:"planerot",i:t},ls.add(u,d)})}var vp=matchMedia("(max-width: 860px)"),aa=matchMedia("(max-width: 1280px), (max-height: 719px)");function fs(){let n=Math.max(1,Fi.clientWidth),t=Math.max(1,Fi.clientHeight);ai.setPixelRatio(Math.min(2,devicePixelRatio||1)),ai.setSize(n,t,!1);let e=n/t,i=e>=1.6&&t<720?"squares":e<=1||n<640?"row":"columns",s,r=null,a=0;if(!v.panels)s=[null,null,null,{x:0,y:0,w:n,h:t}];else if(i==="squares"){let u=Math.min(Math.floor(n/2),t),d=Math.floor(u/2),h=Math.floor(t/2);s=[{x:0,y:0,w:d,h},{x:d,y:0,w:u-d,h},{x:0,y:h,w:d,h:t-h},{x:u,y:0,w:n-u,h:t}],r={x:d,y:h,w:u-d,h:t-h}}else if(i==="row"){let u=!aa.matches,d=Math.floor(n/(u?4:3)),h=Math.min(d,Math.round(t*.4));a=h,s=[{x:0,y:t-h,w:d,h},{x:d,y:t-h,w:d,h},{x:2*d,y:t-h,w:u?d:n-2*d,h},{x:0,y:0,w:n,h:t-h}],r=u?{x:3*d,y:t-h,w:n-3*d,h}:null}else{let u=Math.min(440,Math.max(200,Math.round(n*.3))),d=Math.floor(t/3);s=[{x:0,y:0,w:u,h:d},{x:0,y:d,w:u,h:d},{x:0,y:2*d,w:u,h:t-2*d},{x:u,y:0,w:n-u,h:t}]}let o=N("tip"),c=r||!aa.matches?Fi:N("tipdock");o.parentElement!==c&&c.appendChild(o),o.classList.toggle("cell",!!r),r?Object.assign(o.style,{left:`${r.x}px`,top:`${r.y}px`,right:"auto",width:`${r.w}px`,height:`${r.h}px`}):o.removeAttribute("style"),N("bar").style.bottom=a?`${a+12}px`:"";let l=o.parentElement===Fi&&!r;N("bar").style.top=l?`${o.offsetTop+o.offsetHeight+14}px`:"14px",la.forEach((u,d)=>{if(u.rect=s[d],u.el.hidden=!u.rect,!u.rect)return;Object.assign(u.el.style,{left:u.rect.x+"px",top:u.rect.y+"px",width:u.rect.w+"px",height:u.rect.h+"px"});let h=u.rect.w/u.rect.h;if(u.cam.isPerspectiveCamera)u.cam.aspect=h;else{let{w:f,h:g}=u.cam.userData.content,y=Math.max(g,f/h)*1.08;u.cam.top=y,u.cam.bottom=-y,u.cam.right=y*h,u.cam.left=-y*h}u.cam.updateProjectionMatrix()}),N("hud").style.left=`${s[3].x+12}px`,aa.matches||(nu.style.left=s[3].x+14+"px"),Op()}function bp(){ir.update(),Rv();let n=Ze.clientHeight;for(let t of la){if(!t.rect)continue;let{x:e,y:i,w:s,h:r}=t.rect;ai.setViewport(e,n-i-r,s,r),ai.setScissor(e,n-i-r,s,r),ai.clear(),ai.render(Vi,t.cam)}requestAnimationFrame(bp)}var Bl=N("strip"),Vh=Bl.getContext("2d");function In(){let n=On(),t=Bl.width,e=Bl.height,i=v.mode==="continuous"&&v.pts.length>=2;Bl.style.display=i?"":"none",N("swatches").style.display=i?"none":"";let s=v.mode==="continuous";nu.style.display=s?"":"none",s&&Op(),i?(Vh.clearRect(0,0,t,e),uu(e).forEach((l,u)=>{Vh.fillStyle=oa(l),Vh.fillRect(0,e-1-u,t,1)})):N("swatches").innerHTML=n.map((l,u)=>`<div class="sw" data-i="${u}" data-sel="${v.sel?.kind==="pt"&&v.sel.i===u}"
        data-bad="${!ic(l)}" style="background:${oa(l)}" title="${Fn(l)}"></div>`).join("");{let l=$n(v.cbg),u=v.mode==="continuous"&&v.pts.length>=2?dc():n,d=u.length?Math.min(...u.map(f=>$u(f,l))):null,h=u.length?Math.min(...u.map(f=>Math.abs(Zu(f,l)))):null;N("cnow").textContent=d===null?"\u2013":`${d.toFixed(2)}:1`,N("cnow").style.color=d!==null&&d<v.cmin?"var(--hot)":"",N("lcnow").textContent=h===null?"":`Lc ${Math.round(h)}`,N("lcnow").style.color=h!==null&&h<60?"var(--hot)":""}if(N("lseprow").style.display=v.mode==="discrete"?"":"none",v.mode==="discrete"){let l=1/0;for(let d=0;d<n.length;d++)for(let h=d+1;h<n.length;h++)l=Math.min(l,Math.abs(n[d][0]-n[h][0]));let u=Number.isFinite(l);N("lsepv").textContent=Ju.toFixed(1),N("lnow").textContent=u?l.toFixed(1):"\u2013"}let r=[];if(v.obs.length){let u=(v.mode==="continuous"&&v.pts.length>=2?dc():n).reduce((d,h)=>d+Bu(h,v.obs,Ma(),Xu()),0);r.push(["obstacle cost",u.toFixed(0),u>0])}let a=Wu(v.pts);for(let l of Ta){if(l.mode&&l.mode!==v.mode)continue;let u=l.f(a);r.push([typeof l.label=="function"?l.label():l.label,u<10?u.toFixed(2):u.toFixed(0),!!l.bad&&u>qu,l.key,fb[l.key]])}db(r);let o=v.sel;N("selpanel").style.display=o?"":"none";let c=o?.kind==="pt"?v.pts[o.i]:o?.kind?.startsWith("obs")?v.obs[o.i]?.c:null;if(c&&document.activeElement!==N("hex")&&(N("hex").value=fa[v.cfmt].to(c)),N("hex").closest(".row").style.display=c?"":"none",N("selpreview").style.display=o?"":"none",N("selcolor").style.display=c?"":"none",c&&document.activeElement!==N("selcolor")&&(N("selcolor").value=Fn(c)),N("flip").closest(".row").style.display=o?.kind==="plane"||o?.kind==="planerot"?"":"none",o?.kind==="pt"&&v.pts[o.i]){let[l,u,d]=_s(v.pts[o.i]);N("selinfo").innerHTML=`L ${l.toFixed(1)} C ${u.toFixed(1)} h ${((d+360)%360).toFixed(0)}\xB0 <span class="d" title="nearest CSS color name">${_b(v.pts[o.i])}</span>`}else if((o?.kind==="plane"||o?.kind==="planerot")&&v.planes[o.i]){let l=v.planes[o.i],u=Hi[Jt.space].axes,d=l.n.map((h,f)=>Math.abs(h)<.01?"":`${h>0?"+":"\u2212"}${Math.abs(h).toFixed(2)}\xB7${u[f]}`).filter(Boolean).join(" ").replace(/^\+/,"");N("selinfo").textContent=`plane ${o.i} \xB7 keep ${d} \u2264 ${l.d.toFixed(1)}`}else if((o?.kind==="obs"||o?.kind==="obsr")&&v.obs[o.i]){let l=v.obs[o.i];N("selinfo").innerHTML=`r ${l.r.toFixed(1)} perceived, ${ya(l.r).toFixed(1)} in chart units`}zp(),Bp(),tm(),Mp(),Jl()}var as=N("tipcanvas"),Xt=as.getContext("2d"),Jf=n=>!!n&&(!n.mode||n.mode===v.mode),Kf=(()=>{let n=e=>e*e*(3-2*e),t=[2,4,8,16,32].map((e,i)=>{let s=dr(1237+i*977);return{g:e,h:Array.from({length:(e+1)*(e+1)},()=>s())}});return(e,i)=>{let s=0,r=1,a=0;for(let{g:o,h:c}of t){let l=e*o,u=i*o,d=Math.min(o-1,Math.floor(l)),h=Math.min(o-1,Math.floor(u)),f=n(l-d),g=n(u-h),y=(m,p)=>c[p*(o+1)+m];s+=r*((y(d,h)*(1-f)+y(d+1,h)*f)*(1-g)+(y(d,h+1)*(1-f)+y(d+1,h+1)*f)*g),a+=r,r*=.55}return s/a}})(),Vv={continuous:"sineramp",discrete:"lines"},Gh={sineramp:{mode:"continuous",label:"sineramp",note:"Kovesi\u2019s test: a constant-amplitude sine riding a linear ramp, fading out downward. Where the map loses contrast the wave disappears early; where it has a false edge the flat ramp shows a band.",f:(n,t)=>n+.05*Math.sin(n*32*Math.PI)*(1-t)},field:{mode:"continuous",label:"field",note:"A smooth scalar field. Any ring, ridge or bright seam you can see is the colormap talking, not the data.",f:(n,t)=>{let e=(i,s,r)=>Math.exp(-((n-i)**2+(t-s)**2)/(2*r*r));return .95*e(.26,.62,.2)+.75*e(.68,.36,.26)+.45*e(.46,.84,.14)}},lines:{mode:"discrete",label:"lines",note:"One series per class, crossing and overlapping, over a light and a dark ground. Line work is thin, so a pair that reads as distinct in a swatch row can still merge here."},scatter:{mode:"discrete",label:"scatter",note:"Every class on a light and a dark ground. A swatch that vanishes against either, or that you cannot tell from its neighbor, fails here and not in the metrics."},geo:{label:"geo",note:"A choropleth: one value per region, over synthetic counties on a synthetic coast. Regions are read against their neighbours rather than against a scale, so a map fails here by making two adjacent classes look like one. In discrete mode each swatch is a class."}};function uu(n){if(v.mode!=="continuous"||v.pts.length<2)return On();let t=Ma(),e=Sa().filter(a=>a.length>=2);if(!e.length)return On();let i=e.map(a=>rc(a,t)),s=i.reduce((a,o)=>a+o,0)||1,r=i.map(a=>Math.max(2,Math.round(n*a/s)));return e.flatMap((a,o)=>oc(a,r[o],t))}var Gv=n=>uu(n).map(t=>Yl(v.gray?[t[0],0,0]:t).map(e=>Math.round(255*e)));function Mp(){let n=Math.max(1,Math.round(as.clientWidth)),t=Math.max(1,Math.round(as.clientHeight));(as.width!==n||as.height!==t)&&(as.width=n,as.height=t);let e=Jf(Gh[v.tipKind])?v.tipKind:Vv[v.mode];for(let[u,d]of Object.entries(Gh)){let h=N("tipbtns").querySelector(`[data-tip="${u}"]`),f=Jf(d);if(f&&!h)N("tipbtns").insertAdjacentHTML("beforeend",`<button data-tip="${u}" title="${d.note}">${d.label}</button>`),h=N("tipbtns").lastElementChild;else if(!f&&h){h.remove();continue}h&&(h.ariaPressed=String(u===e))}let i=Gv(256);if(Xt.clearRect(0,0,n,t),!i.length)return;if(e==="geo")return Xv(n,t,i);if(e==="scatter")return qv(n,t,i);if(e==="lines")return Hv(n,t,i);let s=Gh[e].f,r=new Float64Array(n*t),a=1/0,o=-1/0;for(let u=0;u<t;u++)for(let d=0;d<n;d++){let h=s(d/(n-1),u/(t-1));r[u*n+d]=h,h<a&&(a=h),h>o&&(o=h)}let c=o-a||1,l=Xt.createImageData(n,t);for(let u=0;u<n*t;u++){let d=i[Math.round((r[u]-a)/c*(i.length-1))];l.data[u*4]=d[0],l.data[u*4+1]=d[1],l.data[u*4+2]=d[2],l.data[u*4+3]=255}Xt.putImageData(l,0,0)}function Hv(n,t,e){let i=Math.round(n/2);Xt.fillStyle="#ececec",Xt.fillRect(0,0,i,t),Xt.fillStyle="#101014",Xt.fillRect(i,0,n-i,t),Xt.lineWidth=1;for(let s=1;s<4;s++){let r=Math.round(s*t/4)+.5;Xt.strokeStyle="#00000014",Xt.beginPath(),Xt.moveTo(0,r),Xt.lineTo(i,r),Xt.stroke(),Xt.strokeStyle="#ffffff1c",Xt.beginPath(),Xt.moveTo(i,r),Xt.lineTo(n,r),Xt.stroke()}Xt.lineJoin="round",Xt.lineCap="round",Xt.lineWidth=2,e.forEach((s,r)=>{let a=dr(r*2749+91),o=a()*7,c=1.1+2.2*a(),l=(a()-.5)*.9,u=a()*7;Xt.strokeStyle=`rgb(${s.join(" ")})`,Xt.beginPath();for(let d=0;d<=n;d+=3){let h=d/n,f=Math.min(.94,Math.max(.06,.5+l*(h-.5)+.2*Math.sin(o+c*h*6.2832)+.08*Math.sin(u+c*2.3*h*6.2832))),g=t-7-f*(t-14);d===0?Xt.moveTo(d,g):Xt.lineTo(d,g)}Xt.stroke()})}var js=null;function Wv(n,t){if(js&&js.W===n&&js.H===t)return js;let e=9,i=Math.max(3,Math.round(e*t/n)),s=dr(90210),r=[];for(let d=0;d<i;d++)for(let h=0;h<e;h++)r.push([(h+.15+.7*s())/e*n,(d+.15+.7*s())/i*t]);let a=new Int16Array(n*t),o=new Uint8Array(n*t);for(let d=0;d<t;d++)for(let h=0;h<n;h++){let f=0,g=1/0,y=Math.floor(h/n*e),m=Math.floor(d/t*i);for(let p=-1;p<=1;p++)for(let A=-1;A<=1;A++){let S=y+A,M=m+p;if(S<0||M<0||S>=e||M>=i)continue;let C=M*e+S,T=(r[C][0]-h)**2+(r[C][1]-d)**2;T<g&&(g=T,f=C)}a[d*n+h]=f,o[d*n+h]=Kf(h/n,d/t)>.42?1:0}let c=r.map(([d,h])=>Kf(d/n,h/t)),l=Math.min(...c),u=Math.max(...c);return js={W:n,H:t,cell:a,land:o,val:c.map(d=>(d-l)/(u-l||1))},js}function Xv(n,t,e){let i=Wv(n,t),s=Xt.createImageData(n,t),r=[233,233,233];for(let a=0;a<n*t;a++){let o=i.land[a]?e[Math.round(i.val[i.cell[a]]*(e.length-1))]:r;s.data[a*4]=o[0],s.data[a*4+1]=o[1],s.data[a*4+2]=o[2],s.data[a*4+3]=255}for(let a=0;a<t;a++)for(let o=0;o<n;o++){let c=a*n+o;if(i.land[c]&&(o+1<n&&(i.cell[c+1]!==i.cell[c]||!i.land[c+1])||a+1<t&&(i.cell[c+n]!==i.cell[c]||!i.land[c+n])))for(let l=0;l<3;l++)s.data[c*4+l]=Math.round(s.data[c*4+l]*.45)}Xt.putImageData(s,0,0)}function qv(n,t,e){let i=Math.round(t/2);Xt.fillStyle="#f2f2f2",Xt.fillRect(0,0,n,i),Xt.fillStyle="#101014",Xt.fillRect(0,i,n,t-i),e.forEach((s,r)=>{let a=dr(r*7919+13);Xt.fillStyle=`rgb(${s.join(" ")})`;let o=(r+.5)/e.length*n;for(let c=0;c<26;c++){let l=o+(a()-.5)*(n/e.length)*1.5,u=i+(c%2?1:-1)*(.03+.43*a())*t;Xt.beginPath(),Xt.arc(l,u,2.6,0,7),Xt.fill()}})}N("tipbtns").onclick=n=>{let t=n.target.dataset.tip;t&&(v.tipKind=t,Mp())};var Yv=(n,t,e)=>{let i=Object.assign(document.createElement("a"),{href:URL.createObjectURL(new Blob([t],{type:e})),download:n});i.click(),URL.revokeObjectURL(i.href)},oi=()=>(N("scenename").value.trim()||"precept").replace(/[^\w-]+/g,"-"),kl=()=>oi().replace(/\W/g,"_").replace(/^(?=\d)/,"cmap_"),ua=()=>v.mode==="continuous"&&v.pts.length>=2,$v=()=>ua()?uu(256):On();function da(n){let t=n.filter(e=>!ic(e)).length;return[`${oi()} \u2014 generated by precept`,`${Hi[Jt.space].name} \xB7 ${Un[Jt.gamut].name} gamut${v.cvd==="none"?"":` \xB7 optimized under ${v.cvd} at severity ${v.sev}`}`,`${v.pts.length} control point(s)${ua()?", resampled to 256 by arc length":""}`,...Jt.gamut==="srgb"?[]:["NOTE: clipped to sRGB on the way out."],...t?[`NOTE: ${t}/${n.length} sample(s) fell outside the ${Un[Jt.gamut].name} gamut and were mapped into it.`]:[]]}var Sp=n=>ur(xs(n,"srgb")).map(t=>Math.round(255*vs(t))),wp=(n,t)=>Array.from({length:t},(e,i)=>n[Math.round(i*(n.length-1)/(t-1))]);function Zv(n){let t=[];for(let i=0;i<n.length;i+=6)t.push("    "+n.slice(i,i+6).map(s=>`'${Fn(s)}'`).join(", ")+",");let e=ua();return[...da(n).map(i=>`# ${i}`),"from matplotlib import colormaps",`from matplotlib.colors import ${e?"LinearSegmentedColormap":"ListedColormap"}`,"",e?`${kl()} = LinearSegmentedColormap.from_list('${oi()}', [`:`${kl()} = ListedColormap([`,...t,e?"])":`], name='${oi()}')`,`colormaps.register(${kl()})`].join(`
`)}function Jv(n){let t=[`/* ${da(n).join(`
   `)} */`];if(!ua())return[...t,":root {",...n.map((s,r)=>`  --${oi()}-${r}: ${Fn(s)};`),"}"].join(`
`);let e=33,i=wp(n,e);return[...t,":root {",`  --${oi()}: linear-gradient(to right,`,...i.map((s,r)=>`    ${Fn(s)} ${(100*r/(e-1)).toFixed(2)}%${r<e-1?",":""}`),"  );","}"].join(`
`)}function Kv(n){return[...da(n).map(t=>`# ${t}`),"i,t,hex,r,g,b,L,C,h",...n.map((t,e)=>{let[i,s,r]=Sp(t),[a,o,c]=_s(t),l=n.length>1?e/(n.length-1):0;return[e,l.toFixed(6),Fn(t),i,s,r,a.toFixed(3),o.toFixed(3),rn(c).toFixed(2)].join(",")})].join(`
`)}function jv(n){let t=ua(),e=t?wp(n,33):n;return["<ColorMaps>",`  <!-- ${da(n).join(" | ")} -->`,`  <ColorMap name="${oi()}" space="RGB"${t?"":' indexedLookup="true"'}>`,...e.map((i,s)=>{let[r,a,o]=ur(xs(i,"srgb")).map(l=>vs(l).toFixed(6));return`    <Point x="${t?(s/(e.length-1)).toFixed(6):String(s)}" o="1" r="${r}" g="${a}" b="${o}"/>`}),"  </ColorMap>","</ColorMaps>"].join(`
`)}var Qv=n=>JSON.stringify({name:oi(),mode:v.mode,space:Jt.space,gamut:Jt.gamut,notes:da(n),colors:n.map(Fn),control_points:v.pts},null,1),Zl={matplotlib:{ext:"py",mime:"text/x-python",gen:Zv,empty:"# nothing to export \u2014 add some points"},css:{ext:"css",mime:"text/css",gen:Jv,empty:"/* nothing to export */"},csv:{ext:"csv",mime:"text/csv",gen:Kv,empty:"# nothing to export"},paraview:{ext:"xml",mime:"application/xml",gen:jv,empty:"<!-- nothing to export -->"},json:{ext:"json",mime:"application/json",gen:Qv,empty:"{}"}};for(let[n,t]of Object.entries(Zl)){let e=t.gen;t.gen=()=>{let i=$v();return i.length?e(i):t.empty}}var du=()=>JSON.stringify({precept:1,space:Jt.space,gamut:Jt.gamut,icc:Jt.gamut.startsWith("icc-")?Un[Jt.gamut]:void 0,...v,sel:void 0,marks:void 0},null,1),Hh=n=>Array.isArray(n)&&n.length===3&&n.every(Number.isFinite),Zh=n=>Array.isArray(n)?n.every(Zh):n&&typeof n=="object"?Object.values(n).every(Zh):n!==null&&(typeof n!="number"||Number.isFinite(n)),jf=n=>[...N(n).children].map(t=>t.dataset.v);function tb(n){let t=JSON.parse(n);if(t.precept!==1)throw new Error("not a precept scene file");if(t.icc?.p?.length===3&&t.icc.w&&(Un[t.gamut]=t.icc,Su()),!Hi[t.space]||!Un[t.gamut])throw new Error("unknown space or gamut");if(!Array.isArray(t.pts)||!t.pts.every(Hh))throw new Error("bad control points");if(!t.obs?.every(i=>Hh(i.c)&&Number.isFinite(i.r)))throw new Error("bad obstacles");if(!t.planes?.every(i=>Hh(i.n)&&Number.isFinite(i.d)))throw new Error("bad planes");if(!Zh(t))throw new Error("scene contains a non-finite number");for(let[i,s]of[["cvd",Object.keys(mp)],["mode",jf("mode")],["tool",jf("tool")]])if(i in t&&!s.includes(t[i]))throw new Error(`bad ${i}: ${t[i]}`);let e=JSON.parse(du());try{Jh(t)}catch(i){throw Jh(e),i}}function Jh(n){Jt.space=n.space,Jt.gamut=n.gamut;for(let t of Object.keys(v))t in n&&(v[t]=n[t]);"pin"in n||(v.pin=[]),v.w=Object.fromEntries(Ta.map(t=>[t.key,n.w?.[t.key]??1])),v.on=Object.fromEntries(Ta.map(t=>[t.key,n.on?.[t.key]??!Ku.includes(t.key)])),v.sel=null,ca(),fs(),ha(),ki=null,Ql(),de({colors:!0,light:!0})}var eb=n=>btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),nb=n=>Uint8Array.from(atob(n.replace(/-/g,"+").replace(/_/g,"/")),t=>t.charCodeAt(0)),Tp=(n,t)=>new Response(new Blob([n]).stream().pipeThrough(t));async function ib(){let n=eb(await Tp(du(),new CompressionStream("deflate-raw")).arrayBuffer());return history.replaceState(null,"",`#s=${n}`),location.href}async function sb(){let n=/^#s=(.+)$/.exec(location.hash);if(!n)return!1;try{return tb(await Tp(nb(n[1]),new DecompressionStream("deflate-raw")).text()),!0}catch(t){return console.warn("ignoring unreadable scene in the URL:",t.message),!1}}var rb=0;N("iccbtn").onclick=()=>N("iccfile").click();N("iccfile").onchange=async n=>{let t=n.target.files[0];if(n.target.value="",!!t)try{let e=Fu(await t.arrayBuffer(),t.name.replace(/\.[^.]+$/,"")),i=`icc-${++rb}`;Un[i]=e,Jt.gamut=i,Su(),ca(),fs(),ha(),ki=null,v.slice=[...Mt.mid],de({colors:!0})}catch(e){alert(`could not read that profile: ${e.message}`)}};N("huereset").onclick=()=>{v.hue=[0,360],ga()};N("sharelink").onclick=async n=>{let t=await ib();await Ep(n.target,t,"copy link to this palette")};N("savepy").onclick=()=>{let n=Zl[v.fmt];Yv(`${n.ext==="py"?kl():oi()}.${n.ext}`,n.gen()+`
`,n.mime)};async function Ep(n,t,e){let i=!1;try{await navigator.clipboard.writeText(t),i=!0}catch{}if(!i){let s=document.createElement("textarea");s.value=t,s.style.cssText="position:fixed;left:-9999px;top:0",document.body.appendChild(s),s.select();try{i=document.execCommand("copy")}catch{i=!1}s.remove()}return n.textContent=i?"copied":"copy failed",setTimeout(()=>n.textContent=e,i?900:1800),i}N("copypy").onclick=n=>Ep(n.target,Zl[v.fmt].gen(),"copy");N("exportfmt").onchange=n=>{v.fmt=n.target.value};var Wh=(n,t)=>{let e=n.match(/-?\d*\.?\d+/g);return e&&e.length>=t?e.map(Number):null},fa={hex:{label:"hex",hint:"#440154",to:Fn,from:n=>/^#?[0-9a-f]{6}$/i.test(n.trim())?$n(n.trim().replace(/^#/,"")):null},rgb:{label:"rgb 0\u2013255",hint:"68, 1, 84",to:n=>Sp(n).join(", "),from:n=>{let t=Wh(n,3);return t?Ou(t.slice(0,3).map(e=>e/255)):null}},lch:{label:"LCh chart",hint:"26.5 13.1 305",to:n=>{let[t,e,i]=_s(n);return`${t.toFixed(2)} ${e.toFixed(2)} ${rn(i).toFixed(1)}`},from:n=>{let t=Wh(n,3);return t?va([t[0],t[1],t[2]]):null}},oklch:{label:"oklch()",hint:"oklch(26.5% 0.131 305)",to:n=>{let[t,e,i]=_s(n);return`oklch(${t.toFixed(2)}% ${(e/100).toFixed(4)} ${rn(i).toFixed(1)})`},from:n=>{let t=Wh(n,3);return t?va([t[0],t[1]*100,t[2]]):null}}};N("colorfmt").onchange=n=>{v.cfmt=n.target.value,N("hex").placeholder=fa[v.cfmt].hint,de()};function Ap(){if(v.marks.length!==2)return null;let[n,t]=v.marks,e=Wi(n),i=Wi(t);if(!e||!i||e.c!==i.c)return null;let s=e.run.nodes.length,r=Math.min(e.k,i.k),a=Math.max(e.k,i.k);return a-r===1?"inner":e.run.closed&&r===0&&a===s-1?"wrap":null}function ab(){if(v.mode==="discrete")return[];if(v.marks.length!==2)return v.marks.length?["clear marks"]:[];if(Ap())return["disconnect","clear marks"];let[n,t]=v.marks;return fr(n)<2&&fr(t)<2?["connect","clear marks"]:["clear marks"]}function ob(){let[n,t]=v.marks;if(v.marks.length!==2||fr(n)>=2||fr(t)>=2)return;let e=wa(),i=Wi(n),s=Wi(t);if(i.c===s.c){if(i.run.nodes.length<3)return;e[i.c].closed=!0}else{let r=e[i.c],a=e[s.c];r.nodes[r.nodes.length-1]!==n&&r.nodes.reverse(),a.nodes[0]!==t&&a.nodes.reverse(),r.nodes=[...r.nodes,...a.nodes],e.splice(s.c,1)}fc(e),v.marks=[],_r(),pr(),pa(),ps(),de()}function lb(){let n=Ap();if(!n)return;let t=wa(),e=Wi(v.marks[0]);if(n==="wrap")t[e.c].closed=!1;else{let i=t[e.c].nodes,s=Math.min(e.k,Wi(v.marks[1]).k);t[e.c].closed?t[e.c]={nodes:[...i.slice(s+1),...i.slice(0,s+1)],closed:!1}:t.splice(e.c,1,{nodes:i.slice(0,s+1),closed:!1},{nodes:i.slice(s+1),closed:!1})}fc(t),v.marks=[],_r(),pr(),pa(),ps(),de()}var Cp=()=>{if(v.pts.length<2)return[20,90];let n=v.pts.map(t=>t[0]);return[Math.min(...n),Math.max(...n)]},cb=()=>{let[n,t]=Cp(),e=v.pts.length>=2&&v.pts[0][0]>v.pts[v.pts.length-1][0],[i,s]=e?[t,n]:[n,t];v.lprof=Array.from({length:Le},(r,a)=>i+(s-i)*a/(Le-1))},hb=()=>{let[n,t]=Cp(),e=(Le-1)/2;v.lprof=Array.from({length:Le},(i,s)=>n+(t-n)*(1-Math.abs(s-e)/e))};function Rp(n,t,e,i){let s=n.length;if(!s)return i?0:50;if(s===1)return e(n[0]);let r=Math.min(1,Math.max(0,t))*(s-1),a=Math.min(s-2,Math.floor(r)),o=r-a;if(v.cut[a])return e(n[o<.5?a:a+1]);let[c,l]=[e(n[a]),e(n[a+1])];return i?rn(c+mr(l,c)*o):c*(1-o)+l*o}var pa=()=>{let n=On();n.length>=2&&(v.lprof=Array.from({length:Le},(t,e)=>Rp(n,e/(Le-1),i=>i[0],!1)))},ps=()=>{let n=On();n.length>=2&&(v.hprof=Array.from({length:Le},(t,e)=>Rp(n,e/(Le-1),i=>rn(lc(i)),!0)))},ub=()=>{ps();let n=Yu(v.hprof),t=v.hprof[0];v.hprof=Array.from({length:Le},(e,i)=>rn(t+n*i/(Le-1)))},Pp=(n=!1)=>{ps();let t=v.hprof[0],e=v.hprof[Le-1],i=(Le-1)/2,s=mr(e,t),r=s-(n?360*Math.sign(s||1):0);v.hprof=Array.from({length:Le},(a,o)=>rn(o<i?t:o>i?e:t+r/2))},Qf=null;function db(n){let t=N("metrics"),e=n.map(([s,,,r])=>`${s}|${r??""}`).join(";");if(e!==Qf){Qf=e,t.innerHTML="<tbody>"+n.map(([s,r,a,o,c])=>{let l=c?`<span class="q" data-h="${nr(c)}">?</span>`:"";return`<tr data-k="${nr(o??s)}"><td>${o?`<label class="chk"><input type="checkbox" data-on="${o}"${v.on[o]?" checked":""}>${s}</label>`:s}${l}</td><td class="${a?"warn":""}">${r}</td>`+(o?`<td class="w"><input class="w" type="number" min="0" max="20" step="any" data-w="${o}" value="${v.w[o]}"${v.on[o]?"":" disabled"} title="relative pull in the combined step"><span class="mx"${v.on[o]?"":" data-off"}>&times;</span></td>`:'<td class="w"></td>')+"</tr>"}).join("")+"</tbody>",im();return}let i=[...t.tBodies[0].rows].filter(s=>!s.classList.contains("plotrow"));n.forEach(([,s,r,a],o)=>{let c=i[o],l=c?.cells[1];if(!l)return;l.textContent!==String(s)&&(l.textContent=s);let u=r?"warn":"";if(l.className!==u&&(l.className=u),!a)return;let d=c.querySelector("[data-on]");d&&d.checked!==!!v.on[a]&&(d.checked=v.on[a]);let h=c.querySelector("input.w");!h||document.activeElement===h||(+h.value!==v.w[a]&&(h.value=v.w[a]),h.disabled===!!v.on[a]&&(h.disabled=!v.on[a]),c.querySelector(".mx")?.toggleAttribute("data-off",!v.on[a]))})}var fb={rep:"Spread swatches apart.",repcvd:"Spread apart for every observer.",arc:"Trajectory length.",lramp:"Distance from the lightness profile.",chroma:"Distance from the chroma band.",hprof:"Distance from the hue profile.",feas:"Curve outside the feasible set.",pair:"Even spacing over every pair.",contr:"Swatches under the contrast floor.",lsep:"Pairs closer in lightness than the palette could manage.",bend:"Squared curvature along the ramp. A circle is 1, a straight line 0.",sym:"Lightness asymmetry between a diverging map's two arms.",space:"Uneven control point spacing."},pb=`
  ...
  turquoise violet wheat white whitesmoke yellow yellowgreen`.trim().split(/\s+/),mb=null,gb=()=>mb??=(()=>{let n=document.createElement("canvas").getContext("2d");return pb.flatMap(t=>(n.fillStyle="#010203",n.fillStyle=t,n.fillStyle==="#010203"?[]:[[t,$n(n.fillStyle)]]))})(),_b=n=>{let t=zu(),e=null,i=1/0;for(let[s,r]of gb()){let a=Vu(n,r,t,4);a<i&&(i=a,e=s)}return e},cs=null,Ip=0,Lp=()=>({S:structuredClone(v),params:{...Jt},gamuts:Object.fromEntries(Object.entries(Un).filter(([n])=>n.startsWith("icc-"))),disturbed:Qu()}),Kh=!1;function tp(n,t){Kh=!0,v.pts=n,de({light:!t&&++Vp%8!==0}),Kh=!1}function xb(){return cs||(cs=new Worker("./solver-worker.js",{type:"module"}),cs.onmessage=({data:n})=>{if(n.id===Ip){if(n.t==="pts"){us&&tp(n.pts,!1);return}n.t==="final"&&(Dp(),tp(n.pts,!0))}},cs)}function yb(){us||(us=!0,Vp=0,N("run").textContent="stop",N("run").dataset.on="",xb().postMessage({t:"start",id:++Ip,...Lp()}))}function vb(){us&&(Dp(),cs.postMessage({t:"stop"}))}function Dp(){us=!1,N("run").textContent="run Adam",delete N("run").dataset.on}var Oe={l:26,r:10,t:10,b:15},Np={L:{key:"lprof",term:"lramp",lo:0,hi:100,ticks:[0,50,100],hue:!1,meas:n=>n.map(t=>t[0]),clamp:n=>Math.min(100,Math.max(0,n)),fit:pa,p1:cb,p2:hb,labels:["line","arch"],tips:["straight ramp \xB7 double-click to reverse","tent \xB7 double-click for a dark middle"]},H:{key:"hprof",term:"hprof",lo:0,hi:360,ticks:[0,90,180,270,360],hue:!0,meas:n=>n.map(lc).map(rn),clamp:rn,fit:ps,p1:ub,p2:Pp,labels:["sweep","split"],tips:["steady turn \xB7 double-click to reverse","two plateaus \xB7 double-click for the long way"]}};for(let[n,t]of Object.entries(Np))t.root=document.querySelector(`.pplot[data-plot=${n}]`),t.el=t.root.querySelector("canvas"),t.ctx=t.el.getContext("2d"),t.prof=()=>v[t.key];var ma=Object.values(Np),Nl=(n,t)=>Oe.l+t*(n.el.clientWidth-Oe.l-Oe.r),gn=(n,t)=>n.el.clientHeight-Oe.b-(t-n.lo)/(n.hi-n.lo)*(n.el.clientHeight-Oe.t-Oe.b),bb=(n,t)=>(t-Oe.l)/(n.el.clientWidth-Oe.l-Oe.r),Xl=(n,t)=>n.lo+(n.el.clientHeight-Oe.b-t)/(n.el.clientHeight-Oe.t-Oe.b)*(n.hi-n.lo),ra=7,Up=n=>{let t=n.prof();if(!n.hue)return t.slice();let e=[t[0]];for(let i=1;i<t.length;i++)e.push(e[i-1]+mr(t[i],t[i-1]));return e},Fp=n=>{if(n.prof().length<2)return null;let t=Up(n),e=Math.min(...t),i=Math.max(...t),s=n.hue?rn((e+i)/2):(e+i)/2,r=(i-e)/2,a=[];if(n.hue&&r>=180)a.push([n.lo,n.hi]);else for(let c of n.hue?[-360,0,360]:[0]){let l=Math.max(n.lo,s-r+c),u=Math.min(n.hi,s+r+c);u>l&&a.push([l,u])}let o=c=>gn(n,n.hue?rn(c):c);return{u:t,lo:e,hi:i,segs:a,yHi:o(s+r),yLo:o(s-r)}},Mb=(n,t)=>{let e=Fp(n);if(!e)return null;let i=Math.abs(e.yLo-e.yHi)<2*ra;return!i&&Math.abs(t-e.yHi)<=ra?"hi":!i&&Math.abs(t-e.yLo)<=ra?"lo":e.segs.some(([s,r])=>t>=gn(n,r)-ra&&t<=gn(n,s)+ra)?"move":null};function Sb(n,t,e){let i=n.prof(),{u:s,grip:r}=t,a=Math.min(...s),o=Math.max(...s),c=Xl(n,e)-Xl(n,t.y),l=(y,m)=>i[m]=n.hue?rn(y):y;if(r==="move"){let y=n.hue?c:Math.min(n.hi-o,Math.max(n.lo-a,c));s.forEach((m,p)=>l(m+y,p));return}if(o-a<1e-9)return;let u=Math.max(...s.slice(1).map((y,m)=>Math.abs(y-s[m]))),d=n.hue&&u>0?179/u:1/0,h=(y,m,p)=>n.hue?y:Math.min(p,Math.max(m,y)),f=Math.min(d,r==="hi"?(Math.max(a,h(o+c,a,n.hi))-a)/(o-a):(o-Math.min(o,h(a+c,n.lo,o)))/(o-a)),g=r==="hi"?a:o;s.forEach((y,m)=>l(g+(y-g)*f,m))}function Op(){let n=Math.min(2,devicePixelRatio||1);for(let t of ma){let e=Math.max(1,Math.round(t.el.clientWidth*n)),i=Math.max(1,Math.round(t.el.clientHeight*n));t.el.width===e&&t.el.height===i||(t.el.width=e,t.el.height=i,t.ctx.setTransform(n,0,0,n,0,0),t.prof().length&&kp(t))}}var Bp=()=>ma.forEach(kp);function kp(n){let t=n.ctx,e=n.el.clientWidth,i=n.el.clientHeight;if(!e||!i||!n.prof().length)return;let s=getComputedStyle(document.documentElement).getPropertyValue("--hud").trim()||"#3a3a42",r=On(),a=r.length>=2?n.meas(r):[];t.clearRect(0,0,e,i),t.strokeStyle=s,t.globalAlpha=.28,t.lineWidth=1,t.font="9px 'Fira Mono',ui-monospace,monospace",t.fillStyle=s;for(let h of n.ticks)t.beginPath(),t.moveTo(Oe.l,gn(n,h)),t.lineTo(e-Oe.r,gn(n,h)),t.stroke(),t.globalAlpha=.75,t.fillText(String(h).padStart(3),2,gn(n,h)+3),t.globalAlpha=.28;let o=Fp(n);if(o){let h=Oe.l-5;t.globalAlpha=.6,t.beginPath();for(let[f,g]of o.segs)t.moveTo(h,gn(n,g)),t.lineTo(h,gn(n,f));for(let f of[o.yHi,o.yLo])t.moveTo(h-3,f),t.lineTo(h+3,f);t.stroke()}t.globalAlpha=1;let c=(()=>{let h=v.mode==="continuous"?v.pts.length:0;return h<2?[]:v.cut.map((f,g)=>f&&g<h-1?g/(h-1):-1).filter(f=>f>=0)})(),l=(h,f)=>!c.some(g=>h<=g+1e-9&&g<=f-1e-9&&f-h>1e-9),u=(h,f)=>{for(let g=1;g<h.length;g++){if(!l((g-1)/(h.length-1),g/(h.length-1)))continue;let[y,m]=[h[g-1],h[g]],p=Nl(n,(g-1)/(h.length-1)),A=Nl(n,g/(h.length-1)),S=n.hue?mr(m,y):m-y;if(!n.hue||Math.abs(y+S-m)<1e-9){f(p,y,A,m,g);continue}let M=S>0?360:0,C=p+(A-p)*((M-y)/S);f(p,y,C,M,g),f(C,360-M,A,m,g)}};a.length>=2&&(t.lineCap="round",u(a,(h,f,g,y,m)=>{t.beginPath(),t.moveTo(h,gn(n,f)),t.lineTo(g,gn(n,y)),t.strokeStyle="#000",t.lineWidth=5,t.stroke(),t.strokeStyle=oa(r[m]),t.lineWidth=3.5,t.stroke()}));let d=n.prof();t.setLineDash([4,3]),t.lineWidth=1.5,t.strokeStyle=s,u(d,(h,f,g,y)=>{t.beginPath(),t.moveTo(h,gn(n,f)),t.lineTo(g,gn(n,y)),t.stroke()}),t.setLineDash([]);for(let h of c){let f=Nl(n,h+.5/Math.max(1,v.pts.length-1));t.strokeStyle=s,t.globalAlpha=.5,t.lineWidth=1,t.beginPath(),t.moveTo(f,Oe.t),t.lineTo(f,n.el.clientHeight-Oe.b),t.stroke(),t.globalAlpha=1}d.forEach((h,f)=>{t.beginPath(),t.arc(Nl(n,f/(Le-1)),gn(n,h),3.6,0,7),t.fillStyle=s,t.fill(),t.strokeStyle="rgba(255,255,255,.7)",t.lineWidth=1,t.stroke()})}var Ni=null;for(let n of ma){let t=e=>{let i=n.el.getBoundingClientRect();return[e.clientX-i.left,e.clientY-i.top]};n.el.addEventListener("pointerdown",e=>{let[i,s]=t(e),r=i<Oe.l?Mb(n,s):null;r?Ni={p:n,grip:r,y:s,u:Up(n)}:(Ni={p:n,i:Math.min(Le-1,Math.max(0,Math.round(bb(n,i)*(Le-1))))},n.prof()[Ni.i]=n.clamp(Xl(n,s))),n.el.setPointerCapture(e.pointerId),In()}),n.el.addEventListener("pointermove",e=>{if(Ni?.p!==n)return;let[,i]=t(e);Ni.grip?Sb(n,Ni,i):n.prof()[Ni.i]=n.clamp(Xl(n,i)),In()}),n.el.addEventListener("pointerup",()=>{Ni=null})}function zp(){for(let n of ma)n.root.querySelector("[data-on]").checked=!!v.on[n.term],["p1","p2"].forEach((t,e)=>{let i=n.root.querySelector(`[data-p=${t}]`);i.textContent=n.labels[e],i.title=n.tips[e]})}for(let n of ma)n.root.onclick=t=>{let{on:e,p:i}=t.target.dataset??{};if(e)v.on[e]=t.target.checked;else if(i)n[i]();else return;In()},n.root.ondblclick=t=>{let e=t.target.dataset?.p;if(e!=="p1"&&e!=="p2")return;let i=n.prof();if(n.hue)e==="p2"?Pp(!0):v.hprof=i.slice().reverse();else{let[s,r]=[Math.min(...i),Math.max(...i)],a=i.every((o,c)=>Math.abs(o-i[Le-1-c])<1e-9);v.lprof=a?i.map(o=>s+r-o):i.slice().reverse()}In()};function fu(){ai.setClearColor(new Wt(v.bg),1);let[n,t,e]=_s($n(v.bg)),i=n>55,s=i?-1:1,r=(o,c,l=e)=>Fn(xs(va([Math.min(100,Math.max(0,n+s*o)),c,l]))),a=document.documentElement.style;for(let[o,c]of Object.entries({"--panel":v.bg,"--bg":v.bg,"--fg":r(72,Math.min(t*.25,5)),"--dim":r(38,Math.min(t*.25,4)),"--hot":r(34,32,28),"--link":r(46,26,t>3?e+170:250),"--sel":r(15,Math.min(t*.3,4)),"--hud":r(50,Math.min(t*.25,4)),"--line":i?"#0000002e":"#ffffff26","--ctl":i?"#00000012":"#ffffff12"}))a.setProperty(o,c);lu.forEach(o=>o.edge.material.color.set(i?3816002:13027024)),$l.material.color.set(i?3816002:13027024),Bp()}function pu(n){let t=ys(n);v.slice=t.map((e,i)=>Math.min(Mt.hi[i],Math.max(Mt.lo[i],e))),["sL","sA","sB"].forEach((e,i)=>N(e).value=v.slice[i]),[N("vL"),N("vA"),N("vB")].forEach((e,i)=>e.textContent=v.slice[i].toFixed(0))}function sr(n){v.sel=n;let t=n?.kind==="pt"?v.pts[n.i]:n?.kind?.startsWith("obs")?v.obs[n.i]?.c:null;t&&v.lock&&pu(t)}var us=!1,Vp=0;function de({colors:n=!1,light:t=!1}={}){td(),ju(),lu.forEach(xp),wv(),Pv(),Uv(),Fv(),zv(),t||In(),wb()}function Jl(){us&&!Kh&&cs.postMessage({t:"state",...Lp()})}var Ee={past:[],future:[],last:null,timer:0,depth:60};function Gp(){let n=du();n!==Ee.last&&(Ee.last!==null&&Ee.past.push(Ee.last)>Ee.depth&&Ee.past.shift(),Ee.last=n,Ee.future.length=0,qp())}var wb=()=>{clearTimeout(Ee.timer),Ee.timer=setTimeout(Gp,400)};function Hp(n,t){clearTimeout(Ee.timer),n.length&&(t.push(Ee.last),Ee.last=n.pop(),Jh(JSON.parse(Ee.last)),qp())}var Wp=()=>Hp(Ee.past,Ee.future),Xp=()=>Hp(Ee.future,Ee.past),qp=()=>{N("undo").disabled=!Ee.past.length,N("redo").disabled=!Ee.future.length};N("aboutbtn").onclick=async()=>{await Yp,N("aboutdlg").showModal()};var Ul=N("chroma"),Pt={w:420,h:450,m:{l:34,r:10,t:10,b:26},xmax:.75,ymax:.85},ep=null,np=null,mu=null,ip=()=>{if(v.cvd==="none")return null;let n=ke.cvdMatrix(v.cvd,v.sev),t=v.cvd==="tritan"?ac(v.sev):0,e=ke.BRETTEL_TRITAN;return i=>{let s=[0,1,2].map(o=>n[3*o]*i[0]+n[3*o+1]*i[1]+n[3*o+2]*i[2]);if(!t)return s;let r=e.n[0]*i[0]+e.n[1]*i[1]+e.n[2]*i[2]>=0?e.h1:e.h2,a=[0,1,2].map(o=>r[3*o]*i[0]+r[3*o+1]*i[1]+r[3*o+2]*i[2]);return s.map((o,c)=>o+t*(a[c]-o))}},Ue=n=>Pt.m.l+n/Pt.xmax*(Pt.w-Pt.m.l-Pt.m.r),Fe=n=>Pt.h-Pt.m.b-n/Pt.ymax*(Pt.h-Pt.m.t-Pt.m.b),sp=n=>{n.beginPath(),nc.forEach(([t,e],i)=>i?n.lineTo(Ue(t),Fe(e)):n.moveTo(Ue(t),Fe(e))),n.closePath()};function Tb(n){let t=new ImageData(Pt.w,Pt.h),e=t.data,i=new Float32Array(Pt.w*Pt.h).fill(NaN),s=new Float32Array(Pt.w*Pt.h),r=ke.rgbFromXYZ("srgb"),a=nc.map(([o,c])=>[Ue(o),Fe(c)]);for(let o=0;o<Pt.h;o++){let c=[];for(let l=0,u=a.length-1;l<a.length;u=l++){let[d,h]=a[l],[f,g]=a[u];h>o+.5!=g>o+.5&&c.push(d+(o+.5-h)*(f-d)/(g-h))}c.sort((l,u)=>l-u);for(let l=0;l+1<c.length;l+=2)for(let u=Math.ceil(c[l]);u<=c[l+1];u++){let d=(u-Pt.m.l)/(Pt.w-Pt.m.l-Pt.m.r)*Pt.xmax,h=(Pt.h-Pt.m.b-o)/(Pt.h-Pt.m.t-Pt.m.b)*Pt.ymax;if(h<=0)continue;let f=[d/h,1,(1-d-h)/h],g=[0,1,2].map(M=>r[M][0]*f[0]+r[M][1]*f[1]+r[M][2]*f[2]);n&&(g=n(g));let y=Math.max(...g);if(!(y>0))continue;let m=4*(o*Pt.w+u);for(let M=0;M<3;M++)e[m+M]=255*vs(Math.max(0,g[M]/y)**(1/2.2));e[m+3]=255;let[p,A,S]=Nu(f);if(p>0){let M=o*Pt.w+u;i[M]=Math.hypot(A,S)/p,s[M]=(Math.atan2(S,A)*180/Math.PI+360)%360}}}return mu={ratio:i,hue:s},t}function Eb(){let{ratio:n,hue:t}=mu,[e,i]=[v.lo[0],v.lo[1]],[s,r]=[v.hi[0],v.hi[1]],a=v.hue[0]===0&&v.hue[1]===360,o=new Uint8Array(Pt.w*Pt.h);for(let c=0;c<o.length;c++){let l=n[c];if(Number.isNaN(l))continue;let u=l>0?Math.max(e,i/l):i>0?1/0:e,d=l>0?Math.min(s,r/l):s;u>d||(o[c]=a||l*d<1||hc(t[c])?1:0)}return o}function Ab(){let n=Math.min(2,devicePixelRatio||1);Ul.width=Pt.w*n,Ul.height=Pt.h*n,Ul.style.aspectRatio=`${Pt.w} / ${Pt.h}`;let t=Ul.getContext("2d");t.setTransform(n,0,0,n,0,0);let e=getComputedStyle(document.body).getPropertyValue("--panel").trim()||"#1c1c1f";t.fillStyle=e,t.fillRect(0,0,Pt.w,Pt.h),t.fillRect(0,0,1,1);let i=t.getImageData(0,0,1,1).data;t.save(),sp(t),t.clip();let s=`${v.cvd}|${v.sev}`;if(s!==np){let d=document.createElement("canvas");d.width=Pt.w,d.height=Pt.h,d.getContext("2d").putImageData(Tb(ip()),0,0),ep=d,np=s}t.drawImage(ep,0,0,Pt.w,Pt.h);let r=Eb();{let d=new ImageData(Pt.w,Pt.h),h=d.data;for(let g=0;g<r.length;g++)!r[g]&&!Number.isNaN(mu.ratio[g])&&(h[4*g]=i[0],h[4*g+1]=i[1],h[4*g+2]=i[2],h[4*g+3]=214);let f=document.createElement("canvas");f.width=Pt.w,f.height=Pt.h,f.getContext("2d").putImageData(d,0,0),t.drawImage(f,0,0,Pt.w,Pt.h)}t.restore(),t.strokeStyle="rgba(139,139,150,.35)",t.fillStyle="rgba(139,139,150,.9)",t.lineWidth=1,t.font="9px ui-monospace, monospace";for(let d=0;d<=.8;d+=.1)d<=Pt.xmax&&(t.beginPath(),t.moveTo(Ue(d),Fe(0)),t.lineTo(Ue(d),Fe(0)+3),t.stroke(),t.textAlign="center",t.fillText(d.toFixed(1),Ue(d),Fe(0)+13)),d<=Pt.ymax&&(t.beginPath(),t.moveTo(Ue(0),Fe(d)),t.lineTo(Ue(0)-3,Fe(d)),t.stroke(),t.textAlign="right",t.fillText(d.toFixed(1),Ue(0)-6,Fe(d)+3));t.strokeStyle="rgba(139,139,150,.5)",t.beginPath(),t.moveTo(Ue(0),Fe(Pt.ymax)),t.lineTo(Ue(0),Fe(0)),t.lineTo(Ue(Pt.xmax),Fe(0)),t.stroke(),t.textAlign="left",t.fillText("x",Ue(Pt.xmax)-8,Fe(0)+13),t.fillText("y",Ue(0)-12,Fe(Pt.ymax)+8),sp(t),t.strokeStyle="rgba(232,232,236,.55)",t.lineWidth=1,t.stroke();let a=ip(),o=([d,h])=>{if(!a)return[d,h];let f=[d/h,1,(1-d-h)/h],g=ke.rgbFromXYZ("srgb"),y=ke.xyzFromRGB("srgb"),m=[0,1,2].map(M=>g[M][0]*f[0]+g[M][1]*f[1]+g[M][2]*f[2]),p=a(m),A=[0,1,2].map(M=>y[M][0]*p[0]+y[M][1]*p[1]+y[M][2]*p[2]),S=A[0]+A[1]+A[2];return S>0?[A[0]/S,A[1]/S]:[d,h]},c=(d,h,f,g)=>{let y=Un[d];if(!y?.p)return;let m=a?48:1;t.beginPath();let p=!0;for(let M=0;M<3;M++){let[C,T]=y.p[M],[P,x]=y.p[(M+1)%3];for(let E=0;E<=m;E++){let D=E/m,[I,B]=o([C+(P-C)*D,T+(x-T)*D]);p?(t.moveTo(Ue(I),Fe(B)),p=!1):t.lineTo(Ue(I),Fe(B))}}if(t.closePath(),t.strokeStyle=h,t.lineWidth=f,t.stroke(),!g)return;t.fillStyle=h;let[A,S]=o(y.w);t.beginPath(),t.arc(Ue(A),Fe(S),3,0,7),t.fill(),t.strokeStyle="rgba(255,255,255,.85)",t.lineWidth=1,t.stroke()};Jt.gamut!=="srgb"&&c("srgb","rgba(0,0,0,.35)",1,!1),c(Jt.gamut,"#000",1.6,!0);let l=d=>{let[h,f,g]=Uu(ba(d)),y=h+f+g;return y>0?[Ue(h/y),Fe(f/y)]:null};if(v.mode==="continuous"&&v.pts.length>=2){t.lineCap="round",t.lineJoin="round";for(let d of Sa()){let h=d.map(l).filter(Boolean);if(!(h.length<2)){t.beginPath(),h.forEach(([f,g],y)=>y?t.lineTo(f,g):t.moveTo(f,g)),t.strokeStyle="rgba(16,16,18,.85)",t.lineWidth=4,t.stroke(),t.lineWidth=2.8;for(let f=0;f+1<h.length;f++)t.beginPath(),t.moveTo(h[f][0],h[f][1]),t.lineTo(h[f+1][0],h[f+1][1]),t.strokeStyle=oa(d[f]),t.stroke()}}}let u=On();for(let d of u){let h=l(d);h&&(t.beginPath(),t.arc(h[0],h[1],3.4,0,7),t.fillStyle=oa(d),t.fill(),t.strokeStyle="rgba(16,16,18,.85)",t.lineWidth=1.2,t.stroke())}N("chromacap").textContent="Colors are drawn in sRGB, so anything outside that triangle is shown at the nearest it can manage."}N("chromabtn").onclick=()=>{N("chromadlg").showModal(),Ab()};N("chromaclose").onclick=()=>N("chromadlg").close();N("chromadlg").onclick=n=>{n.target===N("chromadlg")&&N("chromadlg").close()};var Cb=/\$\$[\s\S]*?\$\$|\$[^$]*?\$/g,Rb=n=>n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),Fl=n=>`MJXSLOT${n}TOLSXJM`,Pb=n=>n.startsWith("$$")?`\\[${n.slice(2,-2)}\\]`:`\\(${n.slice(1,-1)}\\)`;async function Ib(n,t,e){let i=await fetch(n);if(!i.ok)throw new Error(`${n}: ${i.status}`);let s=[],r=e.parse((await i.text()).replace(Cb,a=>Fl(s.push(a)-1)));s.forEach((a,o)=>{a.startsWith("$$")&&(r=r.replaceAll(`<p>${Fl(o)}</p>`,Fl(o)))}),r=r.replace(/<p>\{\.([\w-]+)\}<\/p>\s*<(\w+)/g,(a,o,c)=>`<${c} class="${o}"`).replace(/<a href="(https?:[^"]*)"/g,'<a href="$1" target="_blank" rel="noopener"'),s.forEach((a,o)=>{r=r.replaceAll(Fl(o),Rb(Pb(a)))}),N(t).innerHTML=r}var rp=[["./about.md","aboutbody"],["./formulation.md","mathbody"],["./spaces.md","spacebody"]],Lb=new Promise(n=>requestAnimationFrame(()=>requestAnimationFrame(n))),Yp=Lb.then(async()=>{let{marked:n}=await import("./chunk-V53LGYHY.js");await Promise.all(rp.map(([t,e])=>Ib(t,e,n)))}).catch(n=>rp.forEach(([,t])=>N(t).textContent=String(n))),Db=()=>new Promise((n,t)=>{let e=document.createElement("script");e.src="./vendor/mathjax-fira/tex-mml-chtml-mathjax-fira.js",e.onload=()=>n(window.MathJax.startup.promise),e.onerror=()=>t(new Error("MathJax did not load")),document.head.append(e)});async function Nb(n){let t=N(n);Object.assign(t.style,{display:"block",visibility:"hidden",position:"fixed",left:"-9999px"});try{await MathJax.typesetPromise([t]),await document.fonts.ready,t.querySelectorAll("mjx-container[tabindex]").forEach(e=>e.removeAttribute("tabindex"))}finally{t.removeAttribute("style")}}var $p=Yp.then(Db),Ub={},jh=n=>Ub[n]??=$p.then(()=>Nb(n)).catch(()=>{});$p.then(()=>jh("mathdlg")).then(()=>jh("spacedlg"));for(let[n,t,e]of[["mathbtn","mathdlg","mathclose"],["spacebtn","spacedlg","spaceclose"]])N(n).onclick=async()=>{await jh(t),N(t).showModal()},N(e).onclick=()=>N(t).close(),N(t).onclick=i=>{i.target===N(t)&&N(t).close()};N("aboutclose").onclick=()=>N("aboutdlg").close();N("aboutdlg").onclick=n=>{n.target===N("aboutdlg")&&N("aboutdlg").close()};N("undo").onclick=Wp;N("redo").onclick=Xp;var ri=new Xr,ap=new xt,or=new Qe,me=null,Qh=null,Bi=null,gu=()=>{Bi&&(clearTimeout(Bi.t),Bi=null)},_u=(n,t)=>la.find(e=>e.rect&&n>=e.rect.x&&n<e.rect.x+e.rect.w&&t>=e.rect.y&&t<e.rect.y+e.rect.h);function Kl(n){Vi.updateMatrixWorld();let t=Ze.getBoundingClientRect(),e=n.clientX-t.left,i=n.clientY-t.top,s=_u(e,i);return s?(ap.set((e-s.rect.x)/s.rect.w*2-1,-((i-s.rect.y)/s.rect.h*2-1)),ri.setFromCamera(ap,s.cam),s):null}function Fb(n){let t=_p[n.axis];or.setFromNormalAndCoplanarPoint(t.normal(),ds(t.corners(v.slice[n.axis])[0]));let e=ri.ray.intersectPlane(or,new R);return e&&Vl(e)}function Ob(n){if(Pn.visible){let e=ri.layers.mask;ri.layers.enable(1);let i=ri.intersectObject(Pn,!1)[0];if(ri.layers.mask=e,i)return Vl(i.point)}or.setFromNormalAndCoplanarPoint(n.cam.getWorldDirection(new R),ds(v.slice));let t=ri.ray.intersectPlane(or,new R);return t&&Vl(t)}var op={pt:0,obsr:0,planerot:0,plane:0,obs:1},xu=()=>{let n=ri.intersectObjects([...Gl.children,...Hl.children,...ls.children],!1).filter(e=>e.object.userData.kind);if(!n.length)return;let t=Math.min(...n.map(e=>op[e.object.userData.kind]));return n.find(e=>op[e.object.userData.kind]===t)};Ze.addEventListener("pointerdown",n=>{let t=Kl(n);if(!t)return;ir.enabled=t.axis===void 0;let e=xu();if(e&&(n.ctrlKey||n.metaKey)&&e.object.userData.kind==="pt"&&v.mode==="continuous"){let{i}=e.object.userData,s=v.marks.indexOf(i);s>=0?v.marks.splice(s,1):v.marks.push(i),ir.enabled=!1,de();return}if(e){if(sr({...e.object.userData}),or.setFromNormalAndCoplanarPoint(t.cam.getWorldDirection(new R),e.object.position.clone()),me={...v.sel},ir.enabled=!1,Ze.setPointerCapture(n.pointerId),n.pointerType!=="mouse"){let{kind:i,i:s}=e.object.userData;Bi={x:n.clientX,y:n.clientY,t:setTimeout(()=>{Bi=null,me=null,Jp(n.clientX,n.clientY,i,s)},520)}}}else if(t.axis!==void 0){me={kind:"pan",q:t,x:n.clientX,y:n.clientY},Ze.setPointerCapture(n.pointerId);return}else return;de()});Ze.addEventListener("dblclick",n=>{let t=Kl(n);if(!t||xu())return;let e=t.axis===void 0?Ob(t):Fb(t);if(e){if(v.tool==="obstacle")v.obs.push({c:e,r:v.rad}),sr({kind:"obs",i:v.obs.length-1});else if(v.tool==="plane"){let i;if(t.axis===void 0){let s=t.cam.getWorldDirection(new R),r=Math.hypot(s.y,s.x,s.z);i=[s.y/r,s.x/r,s.z/r]}else i=[0,0,0],i[t.axis]=1;v.planes.push({n:i,d:gr(i,ys(e))}),sr({kind:"plane",i:v.planes.length-1})}else sr({kind:"pt",i:_v(e)});_r(),de()}});function Bb(n,t){({pt:v.pts,obs:v.obs,obsr:v.obs,plane:v.planes,planerot:v.planes})[n].splice(t,1),n==="pt"&&(v.pin.splice(t,1),t>0&&v.cut[t]&&(v.cut[t-1]=!0),v.cut.splice(t,1),v.marks=v.marks.filter(e=>e!==t).map(e=>e>t?e-1:e))}function Zp(n,t){for(let e of yu(n,t).sort((i,s)=>s-i))Bb(n,e);v.sel=null,de()}var ql=null,yu=(n,t)=>n==="pt"&&v.marks.length&&v.marks.includes(t)?[...v.marks]:[t];function Jp(n,t,e,i){ql={kind:e,i};let s=yu(e,i),r=s.length>1?` ${s.length}`:"",a=e==="pt"?[...ab(),(s.every(l=>v.pin[l])?"unpin":"pin")+r,`delete${r}`]:["delete"],o=N("ctxmenu");o.innerHTML=a.map(l=>`<button data-act="${l}">${l}</button>`).join(""),o.hidden=!1;let c=Fi.getBoundingClientRect();o.style.left=`${Math.min(n-c.left,Fi.clientWidth-o.offsetWidth-6)}px`,o.style.top=`${Math.min(t-c.top,Fi.clientHeight-o.offsetHeight-6)}px`}var vu=()=>{N("ctxmenu").hidden=!0,ql=null};N("ctxmenu").onclick=n=>{let t=n.target.dataset?.act;if(!t||!ql)return;let{kind:e,i}=ql;if(vu(),t==="connect")return ob();if(t==="disconnect")return lb();if(t==="clear marks")return v.marks=[],de();let s=t.split(" ")[0];if(s==="delete")return Zp(e,i);let r=s==="pin";for(let a of yu(e,i))v.pin[a]=r;de()};addEventListener("pointerdown",n=>{!N("ctxmenu").hidden&&!N("ctxmenu").contains(n.target)&&vu()},!0);Ze.addEventListener("contextmenu",n=>{if(!Kl(n))return;let t=xu();t&&(n.preventDefault(),Jp(n.clientX,n.clientY,t.object.userData.kind,t.object.userData.i))});Ze.addEventListener("wheel",n=>{let t=Ze.getBoundingClientRect(),e=_u(n.clientX-t.left,n.clientY-t.top);if(!(!e||e.axis===void 0)){if(n.preventDefault(),n.ctrlKey||n.shiftKey||n.metaKey){e.cam.zoom=Math.min(24,Math.max(.25,e.cam.zoom*(n.deltaY<0?1.12:1/1.12))),e.cam.updateProjectionMatrix();return}jl(e.axis,v.slice[e.axis]-Math.sign(n.deltaY)*zb(e.axis))}},{passive:!1});Ze.addEventListener("pointermove",n=>{if(Bi&&Math.hypot(n.clientX-Bi.x,n.clientY-Bi.y)>8&&gu(),!me){let i=Ze.getBoundingClientRect(),s=_u(n.clientX-i.left,n.clientY-i.top);Qh=s,ir.enabled=!!s&&s.axis===void 0;return}if(me.kind==="pan"){let{q:i}=me,s=2*i.cam.top/i.cam.zoom/i.rect.h,r=new R(1,0,0).applyQuaternion(i.cam.quaternion),a=new R(0,1,0).applyQuaternion(i.cam.quaternion);i.cam.position.addScaledVector(r,-(n.clientX-me.x)*s).addScaledVector(a,(n.clientY-me.y)*s),me.x=n.clientX,me.y=n.clientY;return}if(!Kl(n))return;let t=ri.ray.intersectPlane(or,new R);if(!t)return;let e=Vl(t);if(me.kind==="obsr"){let i=v.obs[me.i];v.obs[me.i].r=Math.min(60,Math.max(1,Du(t.distanceTo(Yn(i.c))/Mt.s)))}else if(me.kind==="plane")v.planes[me.i].d=gr(v.planes[me.i].n,ys(e));else if(me.kind==="planerot"){let i=v.planes[me.i],s=yp(i),r=Bv(t.clone().sub(ds(s))),a=Math.hypot(...r);a>1e-6&&(i.n=r.map(o=>o/a),i.d=gr(i.n,s))}else me.kind==="pt"?v.pts[me.i]=e:v.obs[me.i].c=e;v.lock&&me.kind==="pt"&&pu(e),_r(),de()});Ze.addEventListener("pointerup",()=>{me=null,gu()});Ze.addEventListener("pointercancel",()=>{me=null,gu()});addEventListener("keydown",n=>{if(/^(INPUT|SELECT)$/.test(n.target.tagName))return;let t=(n.ctrlKey||n.metaKey)&&n.key.toLowerCase();if(t==="z"||t==="y")return n.preventDefault(),t==="y"||n.shiftKey?Xp():Wp();if(n.key==="r"&&Qh?.axis!==void 0){hp(Qh.cam);return}v.sel&&((n.key==="Backspace"||n.key==="Delete")&&Zp(v.sel.kind,v.sel.i),n.key==="Escape"&&(vu(),v.sel=null,de()))});var Kp=0;function jp(){let t=(v.pts.length?On():[]).reduce((e,i)=>Math.max(e,Math.hypot(i[1],i[2])),Kp);kb(Math.ceil(t*1.02))}function kb(n){let t=cr[1];if(n!==t){cr[1]=n;for(let e of["cmin","cmax"])N(e).max=n,N(e).step="any";v.hi[1]>=t-1e-9?v.hi[1]=n:v.hi[1]=Math.min(v.hi[1],n),v.lo[1]=Math.min(v.lo[1],v.hi[1]),ki=null,bu()}}var jl=(n,t)=>{v.slice[n]=Math.min(Mt.hi[n],Math.max(Mt.lo[n],+t)),N(["sL","sA","sB"][n]).value=v.slice[n],[N("vL"),N("vA"),N("vB")][n].textContent=v.slice[n].toFixed(0),de()},zb=n=>(Mt.hi[n]-Mt.lo[n])/66;N("sL").oninput=n=>jl(0,n.target.value);N("sA").oninput=n=>jl(1,n.target.value);N("sB").oninput=n=>jl(2,n.target.value);N("shell").oninput=n=>{v.shell=+n.target.value,N("shellv").textContent=er(v.shell),Pn.material.uniforms.uOpacity.value=v.shell,Pn.visible=v.shell>0,ar.visible=v.shell>0,ou()};N("bg").oninput=n=>{v.bg=n.target.value,fu()};N("sliceop").oninput=n=>{v.sliceOp=+n.target.value,N("sliceopv").textContent=er(v.sliceOp),lu.forEach(xp)};N("gamutsel").onchange=n=>{Jt.gamut=n.target.value,ca(),fs(),ha(),ki=null,de({colors:!0})};N("spacesel").onchange=n=>{Jt.space=n.target.value,ca(),fs(),ha(),ki=null,v.slice=[...Mt.mid],["sL","sA","sB"].forEach((t,e)=>N(t).value=v.slice[e]),[N("vL"),N("vA"),N("vB")].forEach((t,e)=>t.textContent=v.slice[e].toFixed(0)),de()};function Vb(n){let t=n.hex.map($n);if(n.mode==="discrete"){let l=100/t.length;return`linear-gradient(90deg, ${t.map((u,d)=>`${$h(u)} ${(d*l).toFixed(3)}% ${((d+1)*l).toFixed(3)}%`).join(", ")})`}let e=Ma(),s=(n.cut===void 0?[t]:[t.slice(0,n.cut+1),t.slice(n.cut+1)]).map(l=>Gu(l.map(u=>ys(u)),uc,n.kind==="cyclic").map(u=>sc(u))),r=s.map(l=>rc(l,e)),a=r.reduce((l,u)=>l+u,0)||1,o=[],c=0;return s.forEach((l,u)=>{let d=100*r[u]/a,h=Math.max(2,Math.round(32*r[u]/a));oc(l,h,e).forEach((f,g)=>o.push(`${$h(f)} ${(c+d*g/(h-1)).toFixed(2)}%`)),c+=d}),`linear-gradient(90deg, ${o.join(", ")})`}var Gb=["sequential","diverging","multi","cyclic","categorical"];function Hb(){let n={};for(let[t,e]of Object.entries(eu))(n[e.kind]??=[]).push([t,e]);N("loadlist").innerHTML=Gb.filter(t=>n[t]).map(t=>`<h4>${t}</h4><div class="pgrid">`+n[t].map(([e,i])=>`<button class="pcard" data-preset="${nr(e)}" title="${nr(e)}, ${i.hex.length} control points"><span class="pramp" style="background:${Vb(i)}"></span><span class="pname">${nr(e)}</span></button>`).join("")+"</div>").join("")}N("panelbtn").onclick=()=>{v.panels=!v.panels,fs(),Ql(),de()};N("loadbtn").onclick=()=>{Hb(),N("loaddlg").showModal()};N("loadclose").onclick=()=>N("loaddlg").close();N("loaddlg").onclick=n=>{n.target===N("loaddlg")&&N("loaddlg").close()};N("loadlist").onclick=n=>{let t=n.target.closest("[data-preset]")?.dataset.preset,e=eu[t];if(e){v.mode=e.mode,v.pts=e.hex.map($n),v.pin=[],v.cut=[],v.marks=[],e.cut!==void 0&&(v.cut[e.cut]=!0),v.loop=[e.kind==="cyclic"],v.sel=null,pr(),pa(),ps(),jp();for(let i of N("mode").children)i.ariaPressed=i.dataset.v===v.mode;N("loaddlg").close(),de()}};function Qp(n){if(!(!v.sel||!n||!n.every(Number.isFinite))){if(v.sel.kind==="pt")v.pts[v.sel.i]=n;else if(v.sel.kind.startsWith("obs"))v.obs[v.sel.i].c=n;else return;v.lock&&pu(n),de()}}N("hex").oninput=n=>Qp(fa[v.cfmt].from(n.target.value));N("selcolor").oninput=n=>Qp($n(n.target.value));N("metrics").onclick=n=>{let{on:t}=n.target.dataset??{};if(t){if(v.on[t]=n.target.checked,n.target.checked){for(let e of Xb)if(e.includes(t))for(let i of e)i!==t&&(v.on[i]=!1)}In()}};var Wb=["rep","repcvd"],Xb=[Wb];N("metrics").oninput=n=>{let t=n.target.dataset?.w;t&&(v.w[t]=Math.max(0,+n.target.value||0),Jl())};var tr=.1,tu=10,qb=220,Yb=n=>+(tr*(tu/tr)**Math.min(1,Math.max(0,n))).toPrecision(2),$b=n=>Math.log(Math.min(tu,Math.max(tr,n||tr))/tr)/Math.log(tu/tr),qn=null;N("metrics").addEventListener("pointerdown",n=>{let t=n.target.closest("input.w");t&&!t.disabled&&(qn={el:t,y:n.clientY,t:$b(+t.value),id:n.pointerId,moved:!1})});addEventListener("pointermove",n=>{if(!qn||n.pointerId!==qn.id)return;let t=qn.y-n.clientY;if(!qn.moved){if(Math.abs(t)<3)return;qn.moved=!0}n.preventDefault();let e=Yb(qn.t+t/qb);qn.el.value=e,v.w[qn.el.dataset.w]=e,Jl()});for(let n of["pointerup","pointercancel"])addEventListener(n,()=>{qn=null});N("run").onclick=()=>us?vb():yb();N("graybtn").onclick=n=>{v.gray=!v.gray,n.currentTarget.ariaPressed=v.gray,In()};N("rate").oninput=n=>{v.rate=+n.target.value,N("ratev").textContent=v.rate.toFixed(2).slice(1),Jl()};N("restart").onchange=n=>{v.restart=n.target.checked,In()};N("cbg").oninput=n=>{v.cbg=n.target.value,In()};N("cfloor").oninput=n=>{v.cmin=Math.max(1,+n.target.value||1),In()};N("flip").onclick=()=>{let n=v.planes[v.sel?.i];!n||!v.sel.kind.startsWith("plane")||(n.n=n.n.map(t=>-t),n.d=-n.d,de())};var zi=N("huewheel"),$e=zi.getContext("2d"),Ui=zi.width,lr=Ui/2,Xh=52,qh=33,Zb=(n,t)=>(Math.atan2(lr-t,n-lr)*180/Math.PI+360)%360,Yh=(n,t)=>[lr+t*Math.cos(n*Math.PI/180),lr-t*Math.sin(n*Math.PI/180)],zl=new Float32Array(720*3),lp=null;function Jb(){let n=`${v.cvd}|${v.sev}|${Jt.gamut}`;if(n!==lp){lp=n;for(let t=0;t<720;t++){let e=t*Math.PI/360,i=ur(ba(xs([62,20*Math.cos(e),20*Math.sin(e)],"srgb")));for(let s=0;s<3;s++)zl[t*3+s]=255*vs(i[s])}}}var cp=null;function tm(){let n=`${v.cvd}|${v.sev}|${Jt.gamut}|${v.hue}`;if(n===cp)return;cp=n,Jb();let t=$e.createImageData(Ui,Ui),e=t.data;for(let i=0;i<Ui;i++)for(let s=0;s<Ui;s++){let r=s-lr+.5,a=lr-i-.5,o=Math.hypot(r,a);if(o<qh||o>Xh)continue;let c=(Math.atan2(a,r)*180/Math.PI+360)%360,l=Math.round(c*2)%720*3,u=hc(c)?1:66/255,d=4*(i*Ui+s);e[d]=zl[l]*u,e[d+1]=zl[l+1]*u,e[d+2]=zl[l+2]*u,e[d+3]=255}$e.putImageData(t,0,0),!(v.hue[0]===0&&v.hue[1]===360)&&($e.lineWidth=2,v.hue.forEach((i,s)=>{let[r,a]=Yh(i,qh-1),[o,c]=Yh(i,Xh+1);$e.beginPath(),$e.moveTo(r,a),$e.lineTo(o,c),$e.strokeStyle="#000",$e.stroke();let[l,u]=Yh(i,(qh+Xh)/2);$e.beginPath(),$e.arc(l,u,4.5,0,7),$e.fillStyle=s===0?"#fff":"#111",$e.fill(),$e.strokeStyle=s===0?"#111":"#fff",$e.lineWidth=1.5,$e.stroke(),$e.lineWidth=2}))}var rr=null,em=n=>{let t=zi.getBoundingClientRect();return Zb((n.clientX-t.left)*Ui/t.width,(n.clientY-t.top)*Ui/t.height)};zi.addEventListener("pointerdown",n=>{let t=em(n);v.hue[0]===0&&v.hue[1]===360?(v.hue=[t,(t+90)%360],rr=1):(rr=cc(t,v.hue[0])<=cc(t,v.hue[1])?0:1,v.hue[rr]=t),zi.setPointerCapture(n.pointerId),ga()});zi.addEventListener("pointermove",n=>{rr!==null&&(v.hue[rr]=em(n),ga())});zi.addEventListener("pointerup",()=>{rr=null});zi.addEventListener("dblclick",()=>{v.hue=[0,360],ga()});var cr=[100,40],Kb=n=>{let t=["transparent 0%"];for(let[e,i]of n)t.push(`transparent ${e*100}%`,`var(--link) ${e*100}%`,`var(--link) ${i*100}%`,`transparent ${i*100}%`);return`linear-gradient(90deg, ${t.join(",")}, transparent 100%)`};function bu(){[["ldual","lmin","lmax","lboundv",0],["cdual","cmin","cmax","cboundv",1]].forEach(([e,i,s,r,a])=>{N(i).value=v.lo[a],N(s).value=v.hi[a],N(r).textContent=`${Math.round(v.lo[a])}\u2013${Math.round(v.hi[a])}`,N(e).querySelector(".fill").style.background=Kb([[v.lo[a]/cr[a],v.hi[a]/cr[a]]])});let[n,t]=v.hue;N("hboundv").textContent=n===0&&t===360?"any":`${n.toFixed(0)}\u2013${t.toFixed(0)}\xB0`,tm()}var ga=()=>{bu(),de({colors:!0})};[["lmin","lo",0],["lmax","hi",0],["cmin","lo",1],["cmax","hi",1]].forEach(([n,t,e])=>{N(n).oninput=i=>{v[t][e]=+i.target.value,v.lo[e]>v.hi[e]&&(v[t==="lo"?"hi":"lo"][e]=v[t][e]),ga()}});N("lock").onchange=n=>{v.lock=n.target.checked};N("planes3d").onchange=n=>{v.planes3d=n.target.checked,nm()};var nm=()=>v.planes3d?hs.layers.enable(3):hs.layers.disable(3);N("sev").oninput=n=>{v.sev=+n.target.value,N("sevv").textContent=er(v.sev),Mu()};N("cvd").onchange=n=>{v.cvd=n.target.value,Mu()};N("swatches").onclick=n=>{let t=n.target.dataset?.i;t!=null&&v.mode==="discrete"&&(sr({kind:"pt",i:+t}),de())};function Mu(){de({colors:!0})}for(let n of["mode","tool"]){N(n).onclick=t=>{let e=t.target.closest("[data-v]");if(e){v[n]=e.dataset.v;for(let i of N(n).children)i.ariaPressed=i.dataset.v===v[n];de()}};for(let t of N(n).children)t.ariaPressed=t.dataset.v===v[n]}function Ql(){N("cvd").value=v.cvd,N("sev").value=v.sev,N("shell").value=v.shell,N("bg").value=v.bg,N("lock").checked=v.lock,N("planes3d").checked=v.planes3d,nm(),N("panelbtn").ariaPressed=String(v.panels),N("sliceop").value=v.sliceOp,N("sliceopv").textContent=er(v.sliceOp),N("rate").value=v.rate,N("ratev").textContent=v.rate.toFixed(2).slice(1),N("restart").checked=v.restart,N("cbg").value=v.cbg,N("cfloor").value=v.cmin,N("exportfmt").value=v.fmt,N("colorfmt").value=v.cfmt,N("hex").placeholder=fa[v.cfmt].hint,N("sevv").textContent=er(v.sev),N("shellv").textContent=er(v.shell),N("spacesel").value=Jt.space,N("gamutsel").value=Jt.gamut,["sL","sA","sB"].forEach((n,t)=>N(n).value=v.slice[t]);for(let n of["mode","tool"])for(let t of N(n).children)t.ariaPressed=t.dataset.v===v[n];bu(),zp(),fu()}Ql();N("spacesel").innerHTML=Object.entries(Hi).map(([n,t])=>`<option value="${n}"${n===Jt.space?" selected":""}>${t.name}</option>`).join("");Su();N("exportfmt").innerHTML=Object.keys(Zl).map(n=>`<option value="${n}">${n}</option>`).join("");N("colorfmt").innerHTML=Object.entries(fa).map(([n,t])=>`<option value="${n}">${t.label}</option>`).join("");ha();Pn.material.uniforms.uOpacity.value=v.shell;Pn.visible=v.shell>0;sr(v.sel);function Su(){N("gamutsel").innerHTML=Object.entries(Un).map(([n,t])=>`<option value="${n}"${n===Jt.gamut?" selected":""}>${t.name}</option>`).join("")}var jb={mode:"Ramp or swatch set.",loadbtn:"Published palettes, as swatches. Click one to load it.",spacesel:"Space the panels are drawn in and distances measured in.",gamutsel:"Which colors are reachable. ICC loads a matrix/TRC RGB profile, \u25B3 draws the gamut on a chromaticity diagram.",cvd:"Simulate a color-vision deficiency. Machado 2009, and Brettel 1997 for tritanopia.",sev:"Below 1 is anomalous trichromacy; 1 is dichromacy. Tritan crosses to Brettel above 0.8.",shell:"Opacity of the gamut solid.",sliceop:"Opacity of the three cut planes.",bg:"Backdrop color. The panel follows it.",planes3d:"Draw the cut planes in the 3D view too.",lock:"Cuts follow the node you touch.",colorfmt:"Notation for the selected node.",lmin:"Lightness band.",cmin:"Chroma band.",huewheel:"Allowed hue arc.",cbg:"Contrast ground and target ratio.",rate:"Step size.",restart:"Jolt and retry on a stall, keeping the best.",run:"Run Adam over every enabled term until you stop it.",scenename:"Name for saved files and exports.",sharelink:"Put the whole setup in the address bar and copy it.",exportfmt:"What copy and save produce."};for(let[n,t]of Object.entries(jb)){let e=document.getElementById(n);if(!e){console.warn(`hint for missing control: ${n}`);continue}(e.closest("label.chk")??e.closest(".row")?.querySelector("label.f")??e.closest(".row")??e.closest("section").querySelector("h2")).insertAdjacentHTML("beforeend",`<span class="q" data-h="${nr(t)}">?</span>`)}v.panels=!vp.matches;pr();pa();ps();Ql();Gp();sb();function im(){let n=["L","H"].map(t=>document.querySelector(`.pplot[data-plot=${t}]`));nu.append(...n.filter(Boolean)),N("metrics").querySelectorAll("tr.plotrow").forEach(t=>t.remove()),aa.matches&&["lramp","hprof"].forEach((t,e)=>{let i=N("metrics").querySelector(`tr[data-k="${t}"]`);if(!i||!n[e])return;let s=i.parentElement.insertBefore(document.createElement("tr"),i.nextSibling);s.className="plotrow";let r=s.appendChild(document.createElement("td"));r.colSpan=3,r.appendChild(n[e])})}function sm(){im(),fs(),In()}for(let n of[vp,aa])n.addEventListener("change",sm);new ResizeObserver(fs).observe(Fi);sm();fu();Mu();bp();requestAnimationFrame(()=>{document.body.classList.add("ready"),N("boot").addEventListener("transitionend",n=>n.target.remove(),{once:!0})});
